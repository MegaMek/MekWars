...
public class CheckAttackCommand implements Command {
    ...
    public void process(StringTokenizer command, String Username) {
        ...
        if (!canProbeFromReserve && p.getDutyStatus() < SPlayer.STATUS_ACTIVE) {
            CampaignMain.cm.toUser("AM:You are not on the frontline. You can't probe enemy forces from reserve!",
                  Username,
                  true);
            return;
        }
        ...
        if (command.hasMoreElements()) {
            ...
            try {
                ...
                CampaignMain.cm.toUser("AM:Improper format. Try: /c checkattack or /c checkattack#armyid",
                      Username,
                      true);
                return;
            }
