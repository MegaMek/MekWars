...
public class MechInfo extends javax.swing.JPanel {
     ...
     */
    public MechInfo(client.MWClient client) {
        mwclient = client;
    ...
    /**
     * Creates new MechInfo for use in previews. Is passed a ficticious config which contains preview camo.
     * <p>
     * Used to generate images in HQ, BM, etc.
     */
    public MechInfo(javax.swing.ImageIcon preview) {
    ...
    public static java.awt.Image getImageFor(Entity m, java.awt.Component c) {

        if (mt == null) {
            mt = new MechTileset(new java.io.File("data/images/units/"));
            try {
    ...
    public void setUnit(Entity m) {
        ...
        javax.swing.ImageIcon camoicon = null;
        this.cm = null;
        ...
        mekwars.client.gui.MechInfo.EntityImage ei = new mekwars.client.gui.MechInfo.EntityImage(unit,
              0xFFFFFF,
              camo,
              this);
    ...
    public void setUnit(client.campaign.CUnit cm, client.campaign.CArmy army) {
        ...
        try // @ salient, this should fix the gui problem.
        {
            ...
            try {
                ...
                MWLogger.errLog("incorrect image filename in mechset.txt for " +
                                      cm.getModelName() +
                                      " " +
                                      client.campaign.CUnit.getTypeClassDesc(cm.getType()));
    ...
    private class EntityImage {
        ...
        private int tint;
        private java.awt.Image camo;
        private java.awt.Image[] facings = new java.awt.Image[6];
        private java.awt.Image[] wreckFacings = new java.awt.Image[6];
