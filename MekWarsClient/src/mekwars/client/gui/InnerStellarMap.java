...
public class InnerStellarMap extends javax.swing.JComponent
     ...
     */
    mekwars.client.gui.InnerStellarMap.InnerStellarMapConfig conf = new mekwars.client.gui.InnerStellarMap.InnerStellarMapConfig();
     ...
     */
    private static class IconProvider extends java.util.TreeMap<String, javax.swing.ImageIcon> {
        /**
         *
         */
        private static final long serialVersionUID = 4594828039895948331L;

        public javax.swing.ImageIcon get(String key) {
            if (!containsKey(key)) {
                put(key, new javax.swing.ImageIcon(key));
            }
            return super.get(key);
        }
    }

    private mekwars.client.gui.InnerStellarMap.IconProvider iconCache = new mekwars.client.gui.InnerStellarMap.IconProvider();

    private Planet selectedPlanet = null;

    java.util.ArrayList<java.util.ArrayList<Position>> overlayLines = new java.util.ArrayList<java.util.ArrayList<Position>>();
     ...
     */
    private javax.swing.JCheckBoxMenuItem[] display = new javax.swing.JCheckBoxMenuItem[displayStr.length];
    ...
    private javax.swing.JCheckBoxMenuItem[] filter = new javax.swing.JCheckBoxMenuItem[filterStr.length];
    ...
    public void mouseClicked(java.awt.event.MouseEvent e) {
        ...
        if (e.getButton() == java.awt.event.MouseEvent.BUTTON3) {
            ...
            // Information
            javax.swing.JMenuItem info = new javax.swing.JMenuItem("Information");
                    ...
                    if (Boolean.parseBoolean(mwclient.getserverConfigs("UseStaticMaps"))) {
                        ...
                        label = new javax.swing.JEditorPane("text/html",
                              "<html>" +
                                    mp.getPPanel()
                                          .getPlanet()
                                          .getAdvanceDescription(mwclient.getUser(mwclient.getUsername())
                                                                       .getUserlevel()) +
                        ...
                        javax.swing.JOptionPane.showMessageDialog(
                              mekwars.client.gui.InnerStellarMap.this,
            ...
            if (mwclient.isLeader() &&
                      mwclient.getUserLevel() >= mwclient.getData().getAccessLevel("PurchaseFactory")) {
                item = new javax.swing.JMenuItem("Purchase Factory");
                item.addActionListener(new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent ae) {
                        mwclient.getMainFrame()
                              .jMenuLeaderPurchaseFactory_actionPerformed(p == null ? null : p.getName());
                    }
                });
                popup.add(item);
            }
                ...
                try {
                    ...
                    if (!loadJar.exists()) {
                        ...
                        c.getDeclaredMethod("createMenu",
                                    new Class[] { client.MWClient.class, mekwars.client.gui.InnerStellarMap.class,
                                                  Integer.class, Integer.class, Planet.class })
                              .invoke(o,
                                    new Object[] { mwclient, this, (int) scr2mapX(e.getX()), (int) scr2mapY(e.getY()),
                ...
                if (Boolean.parseBoolean(mwclient.getserverConfigs("UseStaticMaps"))) {
                    ...
                    label = new javax.swing.JEditorPane("text/html",
                          "<html>" +
                                mp.getPPanel()
                                      .getPlanet()
                                      .getAdvanceDescription(mwclient.getUser(mwclient.getUsername()).getUserlevel()) +
                                "<b>Original Owner:</b><br><font color=" +
                                color +
                                ">" +
                                name +
     ...
     */
    InnerStellarMap(CMapPanel panel, client.MWClient client, CMainFrame mainFrame) {
        mwclient = client;
        ...
        try {
            ...
            conf = (mekwars.client.gui.InnerStellarMap.InnerStellarMapConfig) xml.fromXML(new java.io.FileReader(client.getCacheDir() +
                                                                                                                       "/mapconf.xml"));
            ...
            conf = new mekwars.client.gui.InnerStellarMap.InnerStellarMapConfig();
        }
        ...
        java.util.StringTokenizer tokenizer = new java.util.StringTokenizer(mwclient.getConfigParam("MAPFILTER1"), "$");
    ...
    private Planet nearestNeighbour(double x, double y) {
        java.util.Iterator<Planet> it = mp.getData().getAllPlanets().iterator();
    ...
    public void paint(java.awt.Graphics g) {
        java.util.Collection<Planet> planets = mp.getData().getAllPlanets();
        // background
    ...
    public void processTick() {
        try {
            new MMNetXStream().toXML(conf, new java.io.FileWriter(mwclient.getCacheDir() + "/mapconf.xml"));
    ...
    private boolean planetIsVisible(Planet p) {
        ...
        if (filterSettings[FILTER_FACTION] &&
                  p.getInfluence().getInfluence(mwclient.getPlayer().getMyHouse().getId()) > 0) {
            return true;
        }
