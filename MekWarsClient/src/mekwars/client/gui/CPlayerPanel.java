...
public class CPlayerPanel extends javax.swing.JScrollPane {
    ...
    protected javax.swing.JLabel lblName = new javax.swing.JLabel();
    protected javax.swing.JLabel lblStatus = new javax.swing.JLabel();
    protected javax.swing.JLabel lblExp = new javax.swing.JLabel();
    protected javax.swing.JLabel lblRating = new javax.swing.JLabel();
    protected javax.swing.JLabel lblMoney = new javax.swing.JLabel();
    protected javax.swing.JLabel lblInfluence = new javax.swing.JLabel();
    protected javax.swing.JLabel lblMekbay = new javax.swing.JLabel();
    protected javax.swing.JLabel lblTechs = new javax.swing.JLabel();
    protected javax.swing.JLabel lblRewardPoints = new javax.swing.JLabel();
    ...
    public CPlayerPanel(client.MWClient client) {
        ...
        int center = java.awt.GridBagConstraints.CENTER;
        int none = java.awt.GridBagConstraints.NONE;
        ...
        if (logo) {dimension = new java.awt.Dimension(140, height + 140);} else {
            dimension = new java.awt.Dimension(140, height);
        }
        ...
        dimension = new java.awt.Dimension(140, 150);
        ...
        dimension = new java.awt.Dimension(140, height + 30);
        ...
        if (Boolean.parseBoolean(client.getserverConfigs("ShowReward"))) {InfoPanel.add(lblRewardPoints);}
        ...
        if (logo) {
            PlayerPanel.add(InfoPanel,
                  new java.awt.GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, center, none, insets, 0, 0));
        } else {
            PlayerPanel.add(InfoPanel,
                  new java.awt.GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, center, none, insets, 0, 0));
        }

        if (logo) {
            setPreferredSize(new java.awt.Dimension(130, height + 140));
            setMinimumSize(new java.awt.Dimension(140, height + 140));
            setMaximumSize(new java.awt.Dimension(140, height + 140));
        } else {
            setPreferredSize(new java.awt.Dimension(130, height + 40));
            setMinimumSize(new java.awt.Dimension(140, height + 40));
            setMaximumSize(new java.awt.Dimension(140, height + 40));
        }
    ...
    public void refresh() {
        ...
        if (mwclient.getConfig().isParam("LOGO")) {
            try {
                ...
                ((javax.swing.text.html.HTMLEditorKit) lblLogo.getEditorKit()).read(
                      new java.io.StringReader(mwclient.getPlayer().getLogo()), lblLogo.getDocument(), 0);
        ...
        if (player.getMoney() == 0) {
            ...
            lblMoney.setText(mwclient.moneyOrFluMessage(true, false, -player.getMoney()) +
                                   ": " +
                                   java.text.NumberFormat.getInstance().format(player.getMoney()));
        }
        if (player.getInfluence() == 0) {
            lblInfluence.setText(mwclient.moneyOrFluMessage(false, false, -2) + ": " + player.getInfluence());
        } else {
            lblInfluence.setText(mwclient.moneyOrFluMessage(false, false, -player.getInfluence()) +
                                       ": " +
                                       java.text.NumberFormat.getInstance().format(player.getInfluence()));
        }

        if (mwclient.isUsingAdvanceRepairs()) {
            //when the client first loads it doesn't have data in the vectors.
            try {
                lblMekbay.setText(PP_BAYS +
                                        " " +
                                        player.getFreeBays() +
                                        "/" +
                                        player.getBays() +
        ...
        lblRewardPoints.setText(PP_REWARD +
                                      " " +
                                      player.getRewardPoints() +
                                      "/" +
                                      mwclient.getserverConfigs("XPRewardCap"));
        lblFreeMeks.setText(PP_FREEUNITS +
                                  " " +
