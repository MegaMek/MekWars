...
class BrowserCommandLexer {
    ...
    /**
     * Prints out tokens and line numbers from a file or System.in. If no arguments are given, System.in will be used
     * for input. If more arguments are given, the first argument will be used as the name of the file to use as input
     *
     * @param args program arguments, of which the first is a filename
     *
     * @since ostermillerutils 1.00.00
     *       <p>
     *       private static void main(String[] args) { InputStream in; try { if (args.length > 0){ File f = new
     *       File(args[0]); if (f.exists()){ if (f.canRead()){ in = new FileInputStream(f); } else { throw new
     *       IOException("Could not open " + args[0]); } } else { throw new IOException("Could not find " + args[0]); }
     *       } else { in = System.in; } BrowserCommandLexer shredder = new BrowserCommandLexer(in); String t; while ((t
