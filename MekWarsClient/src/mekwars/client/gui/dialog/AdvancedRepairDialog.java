...
public class AdvancedRepairDialog extends javax.swing.JFrame
    ...
    private java.util.Vector<Integer> techs = new java.util.Vector<Integer>(1, 1);
    ...
    private final javax.swing.JButton okayButton = new javax.swing.JButton("Repair");
    ...
    private javax.swing.JPanel techPanel = new javax.swing.JPanel(new javax.swing.SpringLayout());

    // Text boxes
    private javax.swing.JTextField costField = new javax.swing.JTextField(3);
    // private JTextField workHoursField = new JTextField(3);
    private javax.swing.SpinnerListModel workHoursModel = new javax.swing.SpinnerListModel();
    private javax.swing.JSpinner workHoursField = new javax.swing.JSpinner();
    private javax.swing.JTextField baseRollField = new javax.swing.JTextField(3);
    private javax.swing.SpinnerNumberModel numberOfRetriesEditor = new javax.swing.SpinnerNumberModel();
    private javax.swing.JSpinner numberOfRetriesField = new javax.swing.JSpinner(numberOfRetriesEditor);
    ...
    public AdvancedRepairDialog(client.MWClient c, int unitID, boolean salvage) {
        client.campaign.CUnit pUnit = c.getPlayer().getUnit(unitID);
        Entity unit = null;
        synchronized (pUnit.getEntity()) {
            unit = pUnit.getEntity();
        }
        new mekwars.client.gui.dialog.AdvancedRepairDialog(c, pUnit, unit, salvage);
    }

    public AdvancedRepairDialog(client.MWClient c, client.campaign.CUnit playerUnit, Entity unit, boolean salvage) {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (command.equals(okayCommand)) {
            ...
            if ((critLocation < 0) || (critSlot < 0)) {
                javax.swing.JOptionPane.showMessageDialog(null, "Invaild location/Slot please try again");
                return;
            }
            ...
            if (salvage) {
                mwclient.sendChat("/c salvageunit#" +
                                        unit.getExternalId() +
                                        "#" +
                                        critLocation +
                                        "#" +
            ...
            if ((!UnitUtils.checkRepairViability(unit, critLocation, critSlot, armor) || (numberOfTechs <= 0)) &&
                ...
                mwclient.sendChat("/c repairunit#" +
                                        unit.getExternalId() +
                                        "#" +
                                        critLocation +
                                        "#" +
    ...
    public void mousePressed(java.awt.event.MouseEvent arg0) {
        ...
        if (arg0.getComponent() instanceof javax.swing.JList) {
            javax.swing.JList<String> templist = (javax.swing.JList<String>) arg0.getComponent();
                ...
                if (component != null) {
                    if ((unit instanceof Mech) && (component.indexOf("Cockpit") > -1)) {
                        ...
                        if (!((Mech) unit).isAutoEject()) {
                            javax.swing.JMenuItem info = new javax.swing.JMenuItem("Enable AutoEject");
                            ...
                            javax.swing.JMenuItem info = new javax.swing.JMenuItem("Disable AutoEject");
                            info.addActionListener(new java.awt.event.ActionListener() {
                                public void actionPerformed(java.awt.event.ActionEvent e) {
                                    mwclient.sendChat(
                                          client.MWClient.CAMPAIGN_PREFIX +
                        ...
                        for (int x = 0, n = vAllTypes.size(); x < n; x++) {
                            ...
                            if (bTechMatch &&
                                ...
                                info.setActionCommand(atCheck.getAmmoType() +
                                                            "#" +
    ...
    private void loadPanel() {
        ...
        javax.swing.JPanel armorPanel = new javax.swing.JPanel();

        mainPanel.addMouseListener(this);
        armorPanel.addMouseListener(this);

        mainPanel.setLayout(new javax.swing.BoxLayout(mainPanel, javax.swing.BoxLayout.Y_AXIS));
        armorPanel.setLayout(new javax.swing.BoxLayout(armorPanel, javax.swing.BoxLayout.Y_AXIS));

        javax.swing.JPanel headPanel = new javax.swing.JPanel();
        javax.swing.JPanel torsoPanel = new javax.swing.JPanel();
        javax.swing.JPanel legPanel = new javax.swing.JPanel();

        javax.swing.JPanel laPanel = new javax.swing.JPanel();
        javax.swing.JPanel raPanel = new javax.swing.JPanel();
        javax.swing.JPanel llPanel = new javax.swing.JPanel();
        javax.swing.JPanel rlPanel = new javax.swing.JPanel();
        javax.swing.JPanel ltPanel = new javax.swing.JPanel();
        javax.swing.JPanel rtPanel = new javax.swing.JPanel();
        javax.swing.JPanel ctPanel = new javax.swing.JPanel();

        javax.swing.JPanel headArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel laArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel raArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel llArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel rlArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel ltArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel rtArmorPanel = new javax.swing.JPanel();
        javax.swing.JPanel ctArmorPanel = new javax.swing.JPanel();

        headPanel.setLayout(new javax.swing.BoxLayout(headPanel, javax.swing.BoxLayout.X_AXIS));
        headArmorPanel.setLayout(new javax.swing.BoxLayout(headArmorPanel, javax.swing.BoxLayout.X_AXIS));
        torsoPanel.setLayout(new javax.swing.BoxLayout(torsoPanel, javax.swing.BoxLayout.X_AXIS));
        legPanel.setLayout(new javax.swing.BoxLayout(legPanel, javax.swing.BoxLayout.X_AXIS));
        ...
        synchronized (unit) {
            ...
            for (int location = 0; location < unit.locations(); location++) {
                ...
                java.util.Vector<String> critNames = new java.util.Vector<String>(1, 1);
                java.util.Vector<String> armorNames = new java.util.Vector<String>(3, 1);
                ...
                javax.swing.JList<String> ArmorSlotList = new javax.swing.JList<String>(armorNames);
                ...
                javax.swing.JList<String> CriticalSlotList = new javax.swing.JList<String>(critNames);
                CriticalSlotList.addMouseListener(this);
                CriticalSlotList.addKeyListener(this);
                CriticalSlotList.setVisibleRowCount(critNames.size());
                CriticalSlotList.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
                CriticalSlotList.setFont(new java.awt.Font("Arial", java.awt.Font.PLAIN, 10));
        ...
        torsoPanel = new javax.swing.JPanel();
        legPanel = new javax.swing.JPanel();
        torsoPanel.setLayout(new javax.swing.BoxLayout(torsoPanel, javax.swing.BoxLayout.X_AXIS));
        legPanel.setLayout(new javax.swing.BoxLayout(legPanel, javax.swing.BoxLayout.X_AXIS));
    ...
    private void loadTechPanel() {
        ...
        java.util.Vector<String> techString = new java.util.Vector<String>(4, 1);
        ...
        techComboBox = new javax.swing.JComboBox<String>(techString);
        ...
        techPanel.add(new javax.swing.JLabel("Techs: ", javax.swing.SwingConstants.TRAILING));
        techPanel.add(techComboBox);

        techPanel.add(new javax.swing.JLabel("Hours: ", javax.swing.SwingConstants.TRAILING));
        ...
        techPanel.add(new javax.swing.JLabel("Cost/Roll ", javax.swing.SwingConstants.TRAILING));
        costField.setText("0");
        ...
        if (!salvage) {
            techPanel.add(new javax.swing.JLabel("Attempts: ", javax.swing.SwingConstants.TRAILING));
    ...
    public void setCost() {
        ...
        if (Boolean.parseBoolean(mwclient.getserverConfigs("UseRealRepairCosts"))) {
            ...
            if (critSlot == UnitUtils.LOC_FRONT_ARMOR) {
                armor = true;
                double cost = client.campaign.CUnit.getArmorCost(unit, mwclient, critSlot);
                ...
                armor = true;
                double cost = client.campaign.CUnit.getStructureCost(unit, mwclient);
                ...
                cost = client.campaign.CUnit.getCritCost(unit, mwclient, cs);
    ...
    private void setWorkHours() {
        ...
        java.util.Vector<Integer> tempVector = new java.util.Vector<Integer>(1, 1);
