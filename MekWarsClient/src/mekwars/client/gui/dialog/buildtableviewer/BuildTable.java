...
public class BuildTable {
    ...
    private java.util.HashMap<String, BuildTableEntry> entries = new java.util.HashMap<String, BuildTableEntry>();
    private String name = "";

    private javax.swing.JScrollPane pane = new javax.swing.JScrollPane();
    private javax.swing.JTable table = new javax.swing.JTable();
    private javax.swing.JLabel unusedLabel = new javax.swing.JLabel("This table is not used on this server");
     ...
     */
    private java.util.Map<String, BuildTableEntry> getSortedTable() {
        java.util.Map<String, BuildTableEntry> result = entries.entrySet().stream()
    ...
    public void loadTable() {
        ...
        try {
            java.nio.file.Files.lines(java.nio.file.Paths.get(fileName)).forEach((line) -> {
    ...
    private void buildPanel() {
        ...
        java.util.Map<String, BuildTableEntry> entries = getSortedTable();
        ...
        for (int trow = 0; trow < table.getRowCount(); trow++) {
            javax.swing.table.TableCellRenderer cellRenderer = table.getCellRenderer(row, 1);
            java.awt.Component c = table.prepareRenderer(cellRenderer, trow, 1);
