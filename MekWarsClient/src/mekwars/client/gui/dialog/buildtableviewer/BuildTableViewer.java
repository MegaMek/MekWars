 ...
 *
 */
public class BuildTableViewer extends javax.swing.JDialog implements Runnable {
     ...
     * @param c         the client
     */
    public BuildTableViewer(javax.swing.JFrame mainframe, client.MWClient c) {
    ...
    public void run() {
        if (client.getUserLevel() >= client.getData().getAccessLevel("AdminRequestBuildTable")) {
            client.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c AdminRequestBuildTable#list#true");
        } else if (client.getUserLevel() >= client.getData().getAccessLevel("RequestBuildTable")) {
            client.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c RequestBuildTable#list#true");
        }
