 ...
 *
 */
public class SelectorPanel extends javax.swing.JPanel implements java.awt.event.ActionListener {

    private static final long serialVersionUID = -7776384437283951081L;

    private client.MWClient client;

    private javax.swing.JLabel factionLabel = new javax.swing.JLabel("Faction: ", javax.swing.SwingConstants.TRAILING);
    private javax.swing.JLabel typeLabel = new javax.swing.JLabel("Type: ", javax.swing.SwingConstants.TRAILING);
    private javax.swing.JLabel weightLabel = new javax.swing.JLabel("Weight: ", javax.swing.SwingConstants.TRAILING);
    ...
    private javax.swing.JComboBox<String> factionCombo;

    private java.util.Vector<java.awt.event.ActionListener> listeners = new java.util.Vector<java.awt.event.ActionListener>();
     ...
     * @param c client
     */
    public SelectorPanel(client.MWClient c) {
        this.client = c;
    ...
    private void prepComponents() {
        java.util.TreeSet<String> typeNames = new java.util.TreeSet<String>();
        ...
        java.util.LinkedHashSet<String> weightNames = new java.util.LinkedHashSet<String>();
        ...
        weightCombo = new javax.swing.JComboBox<String>(weightArray);
        typeCombo = new javax.swing.JComboBox<String>(typeArray);
