...
public class BulkRepairDialog extends javax.swing.JFrame
      implements java.awt.event.ActionListener, java.awt.event.KeyListener, javax.swing.event.ChangeListener {
    ...
    private final javax.swing.JButton okayButton = new javax.swing.JButton("Start Repairs");
    ...
    private javax.swing.JPanel MasterPanel = new javax.swing.JPanel();
    private javax.swing.JPanel contentPane;

    private javax.swing.JPanel masterBox = new javax.swing.JPanel(new javax.swing.SpringLayout());
    private javax.swing.JPanel repairBox = new javax.swing.JPanel();
    private javax.swing.JPanel techBox = new javax.swing.JPanel();
    private javax.swing.JPanel rollBox = new javax.swing.JPanel();
    private javax.swing.JPanel costBox = new javax.swing.JPanel();
    private javax.swing.JPanel timeBox = new javax.swing.JPanel();

    private javax.swing.JPanel blankPanel1 = new javax.swing.JPanel();
    private javax.swing.JPanel blankPanel2 = new javax.swing.JPanel();
    private javax.swing.JPanel totalTextPanel = new javax.swing.JPanel();
    private javax.swing.JPanel totalPanel = new javax.swing.JPanel();
    private javax.swing.JPanel timePanel = new javax.swing.JPanel();

    private javax.swing.JCheckBox repairCB = new javax.swing.JCheckBox();

    // Text boxes
    private javax.swing.JLabel costField = new javax.swing.JLabel();
    private javax.swing.JLabel timeField = new javax.swing.JLabel();

    private javax.swing.SpinnerNumberModel baseRollEditor = new javax.swing.SpinnerNumberModel();
    private javax.swing.JSpinner baseRollField = new javax.swing.JSpinner(baseRollEditor);

    private javax.swing.JComboBox<String> techComboBox = new javax.swing.JComboBox<String>();
    private int repairType = mekwars.client.gui.dialog.BulkRepairDialog.TYPE_BULK;
    ...
    private int unitRepairType = mekwars.client.gui.dialog.BulkRepairDialog.UNIT_TYPE_SINGLE;

    public BulkRepairDialog(client.MWClient c, int unitID, int repairType, int unitRepairType) {
        ...
        repairBox.setLayout(new javax.swing.BoxLayout(repairBox, javax.swing.BoxLayout.Y_AXIS));
        costBox.setLayout(new javax.swing.BoxLayout(costBox, javax.swing.BoxLayout.Y_AXIS));
        techBox.setLayout(new javax.swing.BoxLayout(techBox, javax.swing.BoxLayout.Y_AXIS));
        rollBox.setLayout(new javax.swing.BoxLayout(rollBox, javax.swing.BoxLayout.Y_AXIS));
        timeBox.setLayout(new javax.swing.BoxLayout(timeBox, javax.swing.BoxLayout.Y_AXIS));
        ...
        setResizable(true);
        if (!isBulk()) {
            this.setSize(new java.awt.Dimension(440, 287));
        } else {
        ...
        if (command.equals(okayCommand)) {
            ...
            if (isSimple()) {
                ...
                for (int type = ARMOR; type <= ENGINES; type++) {
                    sb.append("#" + ((javax.swing.JComboBox<?>) techBox.getComponent(type)).getSelectedIndex());
                    sb.append("#" + ((javax.swing.JSpinner) rollBox.getComponent(type)).getValue().toString());
                }
                if (unitRepairType == mekwars.client.gui.dialog.BulkRepairDialog.UNIT_TYPE_ALL) {
                    for (client.campaign.CUnit repairUnit : mwclient.getPlayer().getHangar()) {
            ...
            try {
                ...
                int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(location)).getSelectedIndex();
                if (techType == UnitUtils.TECH_PILOT) {
                    techType = playerUnit.getPilot().getSkills().getPilotSkill(PilotSkill.AstechSkillID).getLevel();
                }
                ((javax.swing.JSpinner) rollBox.getComponent(location)).setValue(UnitUtils.techBaseRoll(techType));

                if (((javax.swing.JCheckBox) repairBox.getComponent(location)).isSelected()) {
                    setCost(location);
                } else {
                    ((javax.swing.JLabel) costBox.getComponent(location)).setText("0");
                }
                setTotalCost();
            } catch (Exception ex) {
            }
    ...
    private void loadPanel() {
        ...
        repairBox.add(new javax.swing.JLabel("Repair Type"));
        techBox.add(new javax.swing.JLabel("Tech Type", javax.swing.SwingConstants.LEFT));
        rollBox.add(new javax.swing.JLabel("Base Roll", javax.swing.SwingConstants.LEFT));
        costBox.add(new javax.swing.JLabel("Cost", javax.swing.SwingConstants.LEFT));
        if (isSimple()) {
            timeBox.add(new javax.swing.JLabel("Time", javax.swing.SwingConstants.LEFT));
        }

        for (int x = 0; x < 6; x++) {
            techComboBox = new javax.swing.JComboBox<String>(techList);
            ...
            costField = new javax.swing.JLabel("0");
            costField.setAlignmentX(java.awt.Component.CENTER_ALIGNMENT);
            costField.setPreferredSize(new java.awt.Dimension(50, 100));
            costField.setToolTipText("This is an estimated cost based on tech type and base roll");
            costBox.add(costField);
            timeField = new javax.swing.JLabel("0", javax.swing.SwingConstants.LEFT);
            timeField.setPreferredSize(new java.awt.Dimension(50, 100));
            timeField.setToolTipText("This is an estimated time based on tech type and base roll");
            timeBox.add(timeField);
        }

        repairCB = new javax.swing.JCheckBox("Armor");
        ...
        blankPanel1.add(new javax.swing.JLabel(" "));
        blankPanel2.add(new javax.swing.JLabel(" "));

        costField = new javax.swing.JLabel("0");
        costField.setToolTipText("This is an estimated cost based on tech type and base roll");
        totalPanel.add(costField);
        totalTextPanel.add(new javax.swing.JLabel("Estimated Total:"));
        ...
        if (isSimple()) {
            timeField = new javax.swing.JLabel("0");
    ...
    public void setRepair() {
        ...
        if (isSalvage()) {
            ((javax.swing.JComboBox<?>) techBox.getComponent(ARMOR)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
                  ("SALVAGEARMORTECH"))));
            ((javax.swing.JComboBox<?>) techBox.getComponent(INTERNAL)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
                  ("SALVAGEINTERNALTECH"))));
            ((javax.swing.JComboBox<?>) techBox.getComponent(SYSTEMS)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
                  ("SALVAGESYSTEMSTECH"))));
            ((javax.swing.JComboBox<?>) techBox.getComponent(ENGINES)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
                  ("SALVAGEENGINESTECH"))));
            ((javax.swing.JComboBox<?>) techBox.getComponent(WEAPONS)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
                  ("SALVAGEWEAPONSTECH"))));
            ((javax.swing.JComboBox<?>) techBox.getComponent(EQUIPMENT)).setSelectedIndex(Integer.parseInt(mwclient.getConfigParam(
        ...
        if (UnitUtils.hasArmorDamage(unit)) {
            ((javax.swing.JCheckBox) repairBox.getComponent(ARMOR)).setSelected(true);
            ...
            ((javax.swing.JComboBox<?>) techBox.getComponent(ARMOR)).setSelectedIndex(tech);
            ((javax.swing.JSpinner) rollBox.getComponent(ARMOR)).setValue(roll);
            setArmorCost();
        }

        if (UnitUtils.hasISDamage(unit)) {
            ((javax.swing.JCheckBox) repairBox.getComponent(INTERNAL)).setSelected(true);
            ...
            ((javax.swing.JComboBox<?>) techBox.getComponent(INTERNAL)).setSelectedIndex(tech);
            ((javax.swing.JSpinner) rollBox.getComponent(INTERNAL)).setValue(roll);
            setInternalCost();
        }
                ...
                for (int slot = 0; slot < unit.getNumberOfCriticals(location); slot++) {
                    ...
                    if (cs.getType() == CriticalSlot.TYPE_EQUIPMENT) {
                        ...
                        if (mounted.getType() instanceof WeaponType) {
                            ((javax.swing.JCheckBox) repairBox.getComponent(WEAPONS)).setSelected(true);
                            ...
                            ((javax.swing.JComboBox<?>) techBox.getComponent(WEAPONS)).setSelectedIndex(tech);
                            ((javax.swing.JSpinner) rollBox.getComponent(WEAPONS)).setValue(roll);
                            setWeaponCost();
                        } else if (!(mounted.getType() instanceof WeaponType)) {
                            ((javax.swing.JCheckBox) repairBox.getComponent(EQUIPMENT)).setSelected(true);
                            ...
                            ((javax.swing.JComboBox<?>) techBox.getComponent(EQUIPMENT)).setSelectedIndex(tech);
                            ((javax.swing.JSpinner) rollBox.getComponent(EQUIPMENT)).setValue(roll);
                            setEquipmentCost();
                        }
                    } else if ((cs.getType() == CriticalSlot.TYPE_SYSTEM) && (cs.getIndex() != Mech.SYSTEM_ENGINE)) {
                        ((javax.swing.JCheckBox) repairBox.getComponent(SYSTEMS)).setSelected(true);
                        ...
                        ((javax.swing.JComboBox<?>) techBox.getComponent(SYSTEMS)).setSelectedIndex(tech);
                        ((javax.swing.JSpinner) rollBox.getComponent(SYSTEMS)).setValue(roll);
                        setSystemCost();
                    } else if (UnitUtils.isEngineCrit(cs)) {
                        ((javax.swing.JCheckBox) repairBox.getComponent(ENGINES)).setSelected(true);
                        ...
                        ((javax.swing.JComboBox<?>) techBox.getComponent(ENGINES)).setSelectedIndex(tech);
                        ((javax.swing.JSpinner) rollBox.getComponent(ENGINES)).setValue(roll);
                        setEngineCost();
                    }
                }
            }
    ...
    public void stateChanged(javax.swing.event.ChangeEvent arg0) {
        ...
        location = Integer.parseInt(((javax.swing.JSpinner) arg0.getSource()).getName());
    ...
    private void checkArmor() {
        ...
        if (!((javax.swing.JCheckBox) repairBox.getComponent(ARMOR)).isSelected()) {
            return;
        }

        int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(ARMOR)).getSelectedIndex();
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(ARMOR)).getValue().toString();
        ...
        for (int location = 0; location < unit.locations(); location++) {
            if (isSalvage()) {
                ...
                if (unit.getArmor(location) < unit.getOArmor(location)) {
                    String workOrder = unit.getExternalId() +
                                             "#" +
                                             location +
                                             "#" +
    ...
    private void checkInternal() {
        // check to see if the checked the box
        if (!((javax.swing.JCheckBox) repairBox.getComponent(INTERNAL)).isSelected()) {
            return;
        }

        int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(INTERNAL)).getSelectedIndex();
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(INTERNAL)).getValue().toString();
    ...
    private void checkEngines() {
        // check to see if the checked the box
        if (!((javax.swing.JCheckBox) repairBox.getComponent(ENGINES)).isSelected()) {
            return;
        }
        ...
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(ENGINES)).getValue().toString();
    ...
    private void checkSystems() {
        // check to see if the checked the box
        if (!((javax.swing.JCheckBox) repairBox.getComponent(SYSTEMS)).isSelected()) {
            return;
        }

        int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(SYSTEMS)).getSelectedIndex();
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(SYSTEMS)).getValue().toString();
    ...
    private void checkWeapons() {
        // check to see if the checked the box
        if (!((javax.swing.JCheckBox) repairBox.getComponent(WEAPONS)).isSelected()) {
            return;
        }

        int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(WEAPONS)).getSelectedIndex();
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(WEAPONS)).getValue().toString();
    ...
    private void checkEquipment() {
        // check to see if the checked the box
        if (!((javax.swing.JCheckBox) repairBox.getComponent(EQUIPMENT)).isSelected()) {
            return;
        }

        int techType = ((javax.swing.JComboBox<?>) techBox.getComponent(EQUIPMENT)).getSelectedIndex();
        String baseRoll = ((javax.swing.JSpinner) rollBox.getComponent(EQUIPMENT)).getValue().toString();
    ...
    private void setArmorCost() {
        ...
        if (techType != UnitUtils.TECH_PILOT) {
            techCost = Integer.parseInt(mwclient.getserverConfigs(UnitUtils.techDescription(techType) +
                                                                        "TechRepairCost"));
            techWorkMod = UnitUtils.getTechRoll(unit,
                  ...
                  techType,
                  true,
                  mwclient.getData().getHouseByName(mwclient.getPlayer().getHouse()).getTechLevel()) - baseRoll;
        } else {
            techType = playerUnit.getPilot().getSkills().getPilotSkill(PilotSkill.AstechSkillID).getLevel();
        }
        ...
        for (int location = 0; location < unit.locations(); location++) {
            ...
            if (isSalvage()) {
                ...
                if (unit.hasRearArmor(location)) {
                    ...
                    armorCost = client.campaign.CUnit.getArmorCost(unit, mwclient, location);
                    cost += armorCost * pointsToRepair;
                    cost += techCost * Math.abs(techWorkMod);
                    cost += techCost;
                    setWorkHours(ARMOR, location, 0, true, clear);
    ...
    private void setInternalCost() {
        ...
        double pointsToRepair = 0;
        double armorCost = client.campaign.CUnit.getStructureCost(unit, mwclient);
        double techCost = 0;
        double techWorkMod = 0;
        double cost = 0;
        boolean clear = true;
                ...
                if (unit.getInternal(location) < unit.getOInternal(location)) {
                    if (techType != UnitUtils.TECH_PILOT) {
                        techWorkMod = UnitUtils.getTechRoll(unit,
                              ...
                              techType,
                              true,
                              mwclient.getData().getHouseByName(mwclient.getPlayer().getHouse()).getTechLevel()) -
                                            baseRoll;
                    }
        ...
        for (int location = 0; location < unit.locations(); location++) {
            for (int slot = 0; slot < unit.getNumberOfCriticals(location); slot++) {
                ...
                if ((cs.getType() == CriticalSlot.TYPE_SYSTEM) && (cs.getIndex() != Mech.SYSTEM_ENGINE)) {
                    ...
                    critCost = client.campaign.CUnit.getCritCost(unit, mwclient, cs);
                    techWorkMod = Math.max(techWorkMod, 0);
    ...
    private boolean isSimple() {
        return repairType == mekwars.client.gui.dialog.BulkRepairDialog.TYPE_SIMPLE;
    }

    private boolean isBulk() {
        return repairType == mekwars.client.gui.dialog.BulkRepairDialog.TYPE_BULK;
    }

    private boolean isSalvage() {
        return repairType == mekwars.client.gui.dialog.BulkRepairDialog.TYPE_SALVAGE;
    }
