...
public class PlanetSearchDialog extends javax.swing.JDialog implements java.awt.event.ActionListener {
    ...
    //variables
    private final client.gui.InnerStellarMap map;
    ...
    //constructor
    public PlanetSearchDialog(client.gui.InnerStellarMap map, client.MWClient mwclient) {
        ...
        for (java.util.Iterator<Planet> it = planets.iterator(); it.hasNext(); ) {planetNames.add(it.next().getName());}
