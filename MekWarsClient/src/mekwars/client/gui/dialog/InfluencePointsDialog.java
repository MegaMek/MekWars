...
public final class InfluencePointsDialog implements java.awt.event.ActionListener, java.awt.event.KeyListener {
    ...
    private final javax.swing.JLabel rewardLabel = new javax.swing.JLabel("Choose Action:",
    ...
    public InfluencePointsDialog(client.MWClient c) {

        //save the client
        this.mwclient = c;
        windowName = mwclient.getserverConfigs("FluLongName");
        amountLabel = new javax.swing.JLabel(mwclient.getserverConfigs("FluShortName") + " to use:",
              javax.swing.SwingConstants.TRAILING);
        ...
        if (Integer.parseInt(mwclient.getserverConfigs("FluToRefreshFactory")) > 0) {
            ...
            refreshComboBox = new javax.swing.JComboBox<Object>(factories.toArray());
        }

        if (names.isEmpty()) {names.add("None Available");}

        rewardsComboBox = new javax.swing.JComboBox<Object>(names.toArray());
    ...
    public void keyReleased(java.awt.event.KeyEvent e) {
        ...
        if (selection.equals(refreshCommand)) {
            ...
            costLabel.setText(mwclient.getserverConfigs("FluLongName") +
                                    " Required: " +
                                    cost +
                                    " " +
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (command.equals(okayCommand)) {
            ...
            // @Author Salient (mwosux@gmail.com) , Add RP for CBills
                ...
                mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c useinfluence#4#" + amountText.getText());
            } else {
                mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX +
                                        "mail " +
