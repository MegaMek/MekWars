...
public final class ComponentConverterDialog implements java.awt.event.ActionListener {
    ...
    protected javax.swing.JPanel mainPanel = new javax.swing.JPanel(); // main Panel for everything
    protected javax.swing.JPanel critPanel = new javax.swing.JPanel();
    protected javax.swing.JScrollPane scrollPane = new javax.swing.JScrollPane(); // the scrolly thingy
    protected javax.swing.JPanel masterPanel = new javax.swing.JPanel();

    private javax.swing.JTextField baseTextField = new javax.swing.JTextField(5);
    ...
    protected javax.swing.JComboBox weightCombo;
    protected javax.swing.JComboBox typeCombo;
    protected javax.swing.JComboBox factionCombo;
    ...
    public ComponentConverterDialog(client.MWClient mwclient) {

        this.mwclient = mwclient;

        isMod = mwclient.isMod() || mwclient.isAdmin();

        java.util.Collection<House> factions = mwclient.getData().getAllHouses();
        java.util.TreeSet<String> factionNames = new java.util.TreeSet<String>();// tree to alpha sort
        ...
        if (pane.getValue() == okayButton) {
            ...
            mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c getcomponentconversion");
        } else {
            dialog.dispose();
        }
    }
    ...
    public void findAndSaveConfigs(javax.swing.JPanel panel) {
        ...
        for (int fieldPos = panel.getComponentCount() - 1; fieldPos >= 0; fieldPos--) {
            ...
            if (field instanceof javax.swing.JPanel) {
                ...
                javax.swing.JTextField textBox = (javax.swing.JTextField) field;
    ...
    private void requestComponents(String faction) {
        ...
        mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c getcomponentconversion#" + faction);
        ...
        if (!isAdvanced) {
            ...
            for (BMEquipment eq : mwclient.getCampaign().getBlackMarketParts().values()) {
                ...
                if ((Boolean.parseBoolean(mwclient.getserverConfigs("AllowCrossOverTech"))
                    ...
                    ComponentToCritsConverter converter = mwclient.getCampaign()
