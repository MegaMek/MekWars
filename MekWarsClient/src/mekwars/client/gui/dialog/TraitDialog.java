...
public final class TraitDialog implements java.awt.event.ActionListener, java.awt.event.KeyListener {
    ...
    //BUTTONS
    private final javax.swing.JButton okayButton = new javax.swing.JButton("Add");
    private final javax.swing.JButton cancelButton = new javax.swing.JButton("Close");
    private final javax.swing.JButton removeButton = new javax.swing.JButton("Remove");

    //TEXT FIELDS
    //tab names
    private final javax.swing.JLabel factionLabel = new javax.swing.JLabel("faction:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel traitLabel = new javax.swing.JLabel("Trait:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel gunneryLaserLabel = new javax.swing.JLabel("G/L:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel gunneryBalisticLabel = new javax.swing.JLabel("G/B:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel gunneryMissileLabel = new javax.swing.JLabel("G/M:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel astechLabel = new javax.swing.JLabel("AT:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel tacticalGeniusLabel = new javax.swing.JLabel("TG:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel weaponSpecialistLabel = new javax.swing.JLabel("WS:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel meleeSpecialistLabel = new javax.swing.JLabel("MS:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel dodgeManeuverLabel = new javax.swing.JLabel("DM:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel ironManLabel = new javax.swing.JLabel("IM:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel maneuveringAceLabel = new javax.swing.JLabel("MA:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel NAGLabel = new javax.swing.JLabel("NAG:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel NAPLabel = new javax.swing.JLabel("NAP:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel painResistanceLabel = new javax.swing.JLabel("PR:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel survivalistSkillLabel = new javax.swing.JLabel("SV:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel enhancedInterfaceLabel = new javax.swing.JLabel("EI:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel quickStudyLabel = new javax.swing.JLabel("QS:",
          javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel giftedLabel = new javax.swing.JLabel("GT:", javax.swing.SwingConstants.TRAILING);
    private final javax.swing.JLabel medtechLabel = new javax.swing.JLabel("MT:", javax.swing.SwingConstants.TRAILING);


    private final javax.swing.JTextField gunneryLaserText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField gunneryBalisticText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField gunneryMissileText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField astechText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField tacticalGeniusText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField weaponSpecialistText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField meleeSpecialistText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField dodgeManeuverText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField ironManText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField maneuveringAceText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField NAGText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField NAPText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField painResistanceText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField survivalistSkillText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField enhancedInterfaceText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField quickStudyText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField giftedText = new javax.swing.JTextField(3);
    private final javax.swing.JTextField medtechText = new javax.swing.JTextField(3);

    private javax.swing.JComboBox<String> factionComboBox = new javax.swing.JComboBox<String>();
    private javax.swing.JComboBox<String> traitComboBox = new javax.swing.JComboBox<String>();
    ...
    public TraitDialog(client.MWClient c, boolean player) {
        ...
        for (java.util.Iterator<House> factions = mwclient.getData().getAllHouses().iterator(); factions.hasNext(); ) {
            names.add(factions.next().getName());
        }

        factionComboBox = new javax.swing.JComboBox<String>(names.toArray(new String[names.size()]));
        ...
        //CREATE THE PANELS
        javax.swing.JPanel traitsPanel = new javax.swing.JPanel();//player name, etc

        /*
         * Format the Reward Points panel. Spring layout.
         */
        traitsPanel.setLayout(new javax.swing.BoxLayout(traitsPanel, javax.swing.BoxLayout.Y_AXIS));

        javax.swing.JPanel skillPanel = new javax.swing.JPanel(new javax.swing.SpringLayout());
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (command.equals(okayCommand)) {
            ...
            if (trait.trim().length() < 1) {
                javax.swing.JOptionPane.showMessageDialog(null, "You did not enter a trait name!");
                return;
            }

            String result = getResults(faction, trait);
            mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c addtrait#" + result);
            loadAllFiles();
            loadFactionTraits(faction);
            ...
            if (trait.length() < 1) {
                javax.swing.JOptionPane.showMessageDialog(null, "You have to select a trait before you can remove it!");
                return;
            }
    ...
    private void loadFactionTraits(String faction) {
        java.io.File traitFile = new java.io.File(mwclient.getCacheDir() +
                                                        "/" +
                                                        faction.toLowerCase() +
                                                        "traitnames.txt");
        java.util.TreeSet<String> names = new java.util.TreeSet<String>();
        ...
        try {
            java.io.FileInputStream fis = new java.io.FileInputStream(traitFile);
            dis = new java.io.BufferedReader(new java.io.InputStreamReader(fis));
            while (dis.ready()) {
                java.util.StringTokenizer traitName = new java.util.StringTokenizer(dis.readLine(), delimiter);
    ...
    private void populateTraits(String faction, String trait) {
        ...
        try {
            ...
            dis = new java.io.BufferedReader(new java.io.InputStreamReader(fis));
            while (dis.ready()) {
                java.util.StringTokenizer traitNames = new java.util.StringTokenizer(dis.readLine(), delimiter);
                ...
                if (traitName.equalsIgnoreCase(trait)) {
                    while (traitNames.hasMoreTokens()) {
                        ...
                        } else if (traitID == PilotSkill.GiftedID) {giftedText.setText(traitMod);} else if (traitID ==
                                                                                                                  PilotSkill.QuickStudyID) {
