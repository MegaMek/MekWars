...
public class TableViewerDialog extends javax.swing.JFrame implements java.awt.event.ItemListener {
    ...
    mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel tvModel;

    // maps and sorts
    java.util.TreeMap<Object, mekwars.client.gui.dialog.TableViewerDialog.TableUnit> currentUnits;
    mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] sortedUnits = {};// sorts generated from the map.

    client.MWClient mwclient;

    // constructor
    public TableViewerDialog(client.MWClient client) {
        super("Table Browser");

        mwclient = client;
        currentUnits = new java.util.TreeMap<Object, mekwars.client.gui.dialog.TableViewerDialog.TableUnit>();
        ...
        tvModel = new mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel(mwclient, currentUnits, sortedUnits);
        ...
        generalTable.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                if (e.getClickCount() == 2) {
                    mekwars.client.gui.dialog.TableViewerDialog.TableUnit u = getUnitAtRow(generalTable.getSelectedRow());
                    if (u == null) {
                        return;
                    }
    ...
    // methods
    public mekwars.client.gui.dialog.TableViewerDialog.TableUnit getUnitAtRow(int row) {

        String filename = (String) generalTable.getModel()
                                         .getValueAt(row,
                                               mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.FILENAME);
        if (filename != null) {
                        ...
                        if (hasValidExtension(l) && (weight != 0)) {
                            ...
                            if (Filename.toLowerCase().endsWith(".mul")) {
                                ...
                                for (Entity en : loadedUnits) {
                                    mekwars.client.gui.dialog.TableViewerDialog.TableUnit tu = new mekwars.client.gui.dialog.TableViewerDialog.TableUnit(
                                          en,
                                          frequency);
                                    if (tu != null) {


                                        mekwars.client.gui.dialog.TableViewerDialog.TableUnit eu = currentUnits.get(tu.getRealFilename());// existing
                                        // unit
                                        if (eu != null) {
                                ...
                                if (tu != null) {
                                    ...
                                    mekwars.client.gui.dialog.TableViewerDialog.TableUnit eu = currentUnits.get(Filename);// existing
                                    // unit
                                    if (eu != null) {
                                        eu.addFrequencyFrom(tu);
                                    } else {
    ...
    public void loadTables() {
        ...
        java.util.Iterator<mekwars.client.gui.dialog.TableViewerDialog.TableUnit> it = currentUnits.values().iterator();
        while (it.hasNext()) {
            mekwars.client.gui.dialog.TableViewerDialog.TableUnit currUnit = it.next();
    ...
    static class TableViewerModel extends javax.swing.table.AbstractTableModel {
        ...
        java.util.TreeMap<Object, mekwars.client.gui.dialog.TableViewerDialog.TableUnit> currentUnits;
        mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] sortedUnits;

        int currentSortMode = mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.FREQUENCY;
        ...
        public TableViewerModel(
              client.MWClient c,
              java.util.TreeMap<Object, mekwars.client.gui.dialog.TableViewerDialog.TableUnit> current,
              mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] sorted) {
            mwclient = c;
         ...
         * renderer.
         */
        public mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.TableViewerRenderer getRenderer() {
            return new mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.TableViewerRenderer();
        }
        ...
        public void refreshModel() {
            sortedUnits = new mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] {};
        ...
        public Object getValueAt(int row, int col) {
            ...
            mekwars.client.gui.dialog.TableViewerDialog.TableUnit currU = sortedUnits[row];
         ...
         */
        public mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] sortUnits(int sortMode) {

            // a comparator
            client.util.CUnitComparator comparator = null;

            switch (sortMode) {
                case mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.UNIT:
                ...
                case mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.WEIGHT:
                ...
                case mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.BATTLEVALUE:
                ...
                case mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.FREQUENCY:

                    sortedUnits = currentUnits.values().toArray(sortedUnits);
                    java.util.Arrays.sort(sortedUnits,
                          new java.util.Comparator<mekwars.client.gui.dialog.TableViewerDialog.TableUnit>() {
                              @Override
                              public int compare(
                                    mekwars.client.gui.dialog.TableViewerDialog.TableUnit o1,
                                    mekwars.client.gui.dialog.TableViewerDialog.TableUnit o2) {

                                  try {
                                      mekwars.client.gui.dialog.TableViewerDialog.TableUnit t1 = o1;
                                      mekwars.client.gui.dialog.TableViewerDialog.TableUnit t2 = o2;
                                      Double d1 = 0.0;
                                      Double d2 = 0.0;
                                      if (t1 != null) {
            ...
            // failsafe return
            return new mekwars.client.gui.dialog.TableViewerDialog.TableUnit[] {};
        }
        ...
        private class TableViewerRenderer extends javax.swing.table.DefaultTableCellRenderer {
            ...
            public java.awt.Component getTableCellRendererComponent(javax.swing.JTable table, Object value,
                ...
                Object unit = table.getModel()
                                    .getValueAt(row,
                                          mekwars.client.gui.dialog.TableViewerDialog.TableViewerModel.FILENAME);
                mekwars.client.gui.dialog.TableViewerDialog.TableUnit currU = currentUnits.get(unit);
    ...
    static class TableUnit extends client.campaign.CUnit {
        ...
        public void addFrequencyFrom(mekwars.client.gui.dialog.TableViewerDialog.TableUnit u) {
