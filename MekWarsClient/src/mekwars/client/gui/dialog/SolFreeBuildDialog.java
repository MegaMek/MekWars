...
public class SolFreeBuildDialog extends javax.swing.JFrame implements java.awt.event.ItemListener {
    ...
    javax.swing.JScrollPane generalScrollPane = new javax.swing.JScrollPane();
    ...
    mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel tvModel;

    // maps and sorts
    java.util.TreeMap<Object, mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit> currentUnits;
    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] sortedUnits = {};// sorts generated from the map.

    //@Salient adding this to capture unit selection
    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit selectedUnit;

    client.MWClient mwclient;

    // constructor
    public SolFreeBuildDialog(client.MWClient client) {
        super("Free Unit Browser");

        mwclient = client;
        currentUnits = new java.util.TreeMap<Object, mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit>();
        generalScrollPane = new javax.swing.JScrollPane();

        // alpha sorted faction array. hacky and evil.
        java.util.TreeSet<String> factionNames = new java.util.TreeSet<String>();// tree to alpha
        ...
        if (mwclient.getserverConfigs("Sol_FreeBuild_UseAll").equalsIgnoreCase("true") &&
            ...
            java.util.Iterator<House> i = mwclient.getData().getAllHouses().iterator();
            while (i.hasNext()) {
                House house = i.next();
        ...
        // CONSTRUCT GUI
        // make combo boxes
        weightClassCombo = new javax.swing.JComboBox<String>(weightClassArray);
        factionCombo = new javax.swing.JComboBox<String>(factionArray);
        unitTypeCombo = new javax.swing.JComboBox<String>();
		...
		*/
        ...
        tvModel = new mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel(mwclient,
              currentUnits,
              sortedUnits);
        client.gui.TableSorter sorter = new client.gui.TableSorter(tvModel,
              client,
              client.gui.TableSorter.SORTER_BUILDTABLES);
        ...
        generalTable.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                if (e.getClickCount() == 2) {
                    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit u = getUnitAtRow(generalTable.getSelectedRow());
                    if (u == null) {
                        return;
                    }
                    ...
                    UnitDisplay unitDetailInfo = new client.gui.MWUnitDisplay(null, client);
    ...
    // methods
    public mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit getUnitAtRow(int row) {

        String filename = (String) generalTable.getModel()
                                         .getValueAt(row,
                                               mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.FILENAME);
        if (filename != null) {
    ...
    public void doTableLayer(java.util.TreeMap<String, Double> curr, java.util.TreeMap<String, Double> next, String add,
         ...
         */
        java.util.Iterator<String> it = curr.keySet().iterator();
        while (it.hasNext()) {
            String currTableName = it.next();

            // get zip entry for the new file.
            java.io.File tableEntry = null;
            if (commonOverride) {
                        ...
                        if (hasValidExtension(l) && (weight != 0)) {
                            ...
                            if (Filename.toLowerCase().endsWith(".mul")) {
                                ...
                                for (Entity en : loadedUnits) {
                                    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit tu = new mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit(
                                          en,
                                          frequency);
                                    if (tu != null) {


                                        mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit eu = currentUnits.get(tu.getRealFilename());// existing
                                        // unit
                                        if (eu != null) {
                                ...
                                if (tu != null) {
                                    ...
                                    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit eu = currentUnits.get(
                                          Filename);// existing
                                    // unit
                                    if (eu != null) {
                                        eu.addFrequencyFrom(tu);
                            ...
                            if (next != null) {
                                if (next.containsKey("crossTableName")) {
                                    ...
                                    double newTableWeight = d.doubleValue() +
    ...
    public void loadTables() {
         ...
         */
        java.io.File buildTablePath = null;
         ...
         */
        java.util.TreeMap<String, Double> crossMap1 = new java.util.TreeMap<String, Double>();
        java.util.TreeMap<String, Double> crossMap2 = new java.util.TreeMap<String, Double>();
         ...
         */
        java.util.TreeMap<String, Double> temp = new java.util.TreeMap<String, Double>();
        ...
        while (true) {
            ...
            crossMap1 = crossMap2;
            crossMap2 = new java.util.TreeMap<String, Double>();
        }
        ...
        java.util.Iterator<mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit> it = currentUnits.values()
                                                                                              .iterator();
        while (it.hasNext()) {
            mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit currUnit = it.next();
     ...
     */
    static class TableViewerModel extends javax.swing.table.AbstractTableModel {
        ...
        java.util.TreeMap<Object, mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit> currentUnits;
        mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] sortedUnits;

        int currentSortMode = mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.FREQUENCY;
        ...
        public TableViewerModel(
              client.MWClient c,
              java.util.TreeMap<Object, mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit> current,
              mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] sorted) {
            mwclient = c;
         ...
         * renderer.
         */
        public mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.TableViewerRenderer getRenderer() {
            return new mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.TableViewerRenderer();
        }
        ...
        public void refreshModel() {
            sortedUnits = new mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] {};
        ...
        public Object getValueAt(int row, int col) {
            ...
            mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit currU = sortedUnits[row];
         ...
         */
        public mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] sortUnits(int sortMode) {

            // a comparator
            client.util.CUnitComparator comparator = null;

            switch (sortMode) {
                case mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.UNIT:

                    sortedUnits = currentUnits.values().toArray(sortedUnits);
                    comparator = new client.util.CUnitComparator(client.util.CUnitComparator.HQSORT_NAME);
                    java.util.Arrays.sort(sortedUnits, comparator);
                    return sortedUnits;

                case mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.WEIGHT:

                    sortedUnits = currentUnits.values().toArray(sortedUnits);
                    comparator = new client.util.CUnitComparator(client.util.CUnitComparator.HQSORT_WEIGHTTONS);
                    java.util.Arrays.sort(sortedUnits, comparator);
                    return sortedUnits;

                case mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.BATTLEVALUE:

                    sortedUnits = currentUnits.values().toArray(sortedUnits);
                    comparator = new client.util.CUnitComparator(client.util.CUnitComparator.HQSORT_BV);
                    java.util.Arrays.sort(sortedUnits, comparator);
                    return sortedUnits;

                case mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.FREQUENCY:

                    sortedUnits = currentUnits.values().toArray(sortedUnits);
                    java.util.Arrays.sort(sortedUnits,
                          new java.util.Comparator<mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit>() {
                              @Override
                              public int compare(
                                    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit o1,
                                    mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit o2) {

                                  try {
                                      mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit t1 = o1;
                                      mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit t2 = o2;
                                      Double d1 = 0.0;
                                      Double d2 = 0.0;
                                      if (t1 != null) {
                                          d1 = t1.getFrequency();
            ...
            // failsafe return
            return new mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit[] {};
        }

        /*
         * TableViewerRenderer ... This needs quite a bit more polish ...
         */
        private class TableViewerRenderer extends javax.swing.table.DefaultTableCellRenderer {
            ...
            public java.awt.Component getTableCellRendererComponent(javax.swing.JTable table, Object value,
                ...
                Object unit = table.getModel()
                                    .getValueAt(row,
                                          mekwars.client.gui.dialog.SolFreeBuildDialog.TableViewerModel.FILENAME);
                mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit currU = currentUnits.get(unit);
                ...
                java.util.Iterator<String> i = currU.getTables().keySet().iterator();
    ...
    /**
     * TableUnit is a CUnit with added stat-tracking for ongoing frequency calculations. Much like the BMUnit; however,
     * the TableUnit is less complex.
     */
    static class TableUnit extends client.campaign.CUnit {
        ...
        public TableUnit(String fn, double f) {
            ...
            tables = new java.util.TreeMap<String, Double>();
        }
        ...
        public void addFrequencyFrom(mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit u) {
        ...
        /**
         * Tries to setUnitEntity from a filename w/ extension. This used to be the default way of getting units, but
         * CUnit was changed to use the MegaMek summary cache. Because the table viewer reads the tables the same way
         * the server does, it needs a server-style loading cascade, ugly as it may be :-(
         */
        private void createEntityFromFilename(String fn) {

            unitEntity = null;
            try {
                unitEntity = new MechFileParser(new java.io.File("./data/mechfiles/Meks.zip"), fn).getEntity();
            } catch (Exception e) {
                try {
                    unitEntity = new MechFileParser(new java.io.File("./data/mechfiles/Vehicles.zip"), fn).getEntity();
                } catch (Exception ex) {
                    try {
                        unitEntity = new MechFileParser(new java.io.File("./data/mechfiles/Infantry.zip"),
                              fn).getEntity();
                    } catch (Exception exc) {
                        try {
    ...
    public void refreshButton_ActionPerformed() {
        ...
        if (userLevel >= mwclient.getData().getAccessLevel("AdminRequestBuildTable")) {
            mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c AdminRequestBuildTable#list#true");
        } else if (userLevel >= mwclient.getData().getAccessLevel("RequestBuildTable")) {
            mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c RequestBuildTable#list#true");
        }
                            ...
                            .equalsIgnoreCase("true")) //may not need this, command will always check house table if postdefection is enabled.
            {
                mwclient.sendChat(
                      client.MWClient.CAMPAIGN_PREFIX +
                            ...
                            "#" +
                            mekwars.client.gui.dialog.SolFreeBuildDialog.TableUnit.getEntityWeight(tempEntity) +
                            "#" +
