...
public class TableSorter extends TableMap {
    ...
    int indexes[];
    java.util.Vector<Integer> sortingColumns = new java.util.Vector<Integer>(1, 1);
    ...
    // CONSTRUCTOR
    public TableSorter(javax.swing.table.TableModel model, client.MWClient mwclient, int mode) {
        setModel(model);
    ...
    public void loadSavedSortPreferences(int mode) {
        ...
        if (mode == mekwars.client.gui.TableSorter.SORTER_BM) {
        ...
        } else if (mode == mekwars.client.gui.TableSorter.SORTER_BUILDTABLES) {
        ...
        } else if (mode == mekwars.client.gui.TableSorter.SORTER_BMPARTS) {
    ...
    public void addMouseListenerToHeaderInTable(javax.swing.JTable table) {
        final mekwars.client.gui.TableSorter sorter = this;
