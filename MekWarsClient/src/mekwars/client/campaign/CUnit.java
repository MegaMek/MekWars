...
public class CUnit extends Unit {
    ...
    public CUnit(client.MWClient mwclient) {
    ...
    public boolean setData(String data) {
        ...
        // then set up ammo loadout
        {
            try {
                ...
                java.util.ArrayList<Mounted> e = unitEntity.getAmmo();
    ...
    private void setUnitQuirks(String data) {
        ...
        if (quirkList != null) {
            st = new java.util.StringTokenizer(quirkList, "&");
            while (st.hasMoreTokens()) {
                String quirk = TokenReader.readString(st);
                if (quirk.equalsIgnoreCase("none") == false) {unitEntity.getQuirks().getOption(quirk).setValue(true);}
    ...
    public String quirkCheck() {
        ...
        for (java.util.Enumeration<IOptionGroup> optionGroups = unitEntity.getQuirks().getGroups();
     ...
     */
    public static int getPriceForUnit(client.MWClient mwclient, int weightclass,
     ...
     */
    public static int getInfluenceForUnit(client.MWClient mwclient, int weightclass,
          int type_id, House producer) {
     ...
     */
    public static int getPPForUnit(client.MWClient mwclient, int weightclass,
          int type_id, House producer) {
    ...
    public static double getArmorCost(Entity unit, client.MWClient client, int location) {
        double cost = 0.0;
    ...
    public static double getStructureCost(Entity unit, client.MWClient client) {
        double cost = 0.0;
    ...
    public static double getCritCost(Entity unit, client.MWClient client,
          CriticalSlot crit) {
        double cost = 0.0;
