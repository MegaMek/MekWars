...
public class CPersonalPilotQueues {
     ...
     */
    private java.util.ArrayList<java.util.LinkedList<Pilot>> mekPilots = new java.util.ArrayList<java.util.LinkedList<Pilot>>();
    private java.util.ArrayList<java.util.LinkedList<Pilot>> protoPilots = new java.util.ArrayList<java.util.LinkedList<Pilot>>();
    private java.util.ArrayList<java.util.LinkedList<Pilot>> aeroPilots = new java.util.ArrayList<java.util.LinkedList<Pilot>>();
     ...
     */
    private java.util.ArrayList<java.util.LinkedList<Pilot>> getUnitTypeQueue(int typeToGet) {
    ...
    /**
     * Private method which reads SPilot data from a PPQ string. Eliminates dulpicative code in formString's multiple
     * loops thorugh the full data.
     */
     ...
     */
    public void addPilot(java.util.StringTokenizer ST) {
        try {
     ...
     */
    public void removePilot(java.util.StringTokenizer ST) {
    ...
    /**
     * Method that returns a particular class/size queue. Used throughout the client code to fecth queue, which are then
    ...
    public void fromString(String stringFromServer) {
        ...
        java.util.StringTokenizer mainTokenizer = new java.util.StringTokenizer(stringFromServer, "$");

        // first, clear all existing pilots from the linked lists
        for (java.util.LinkedList<Pilot> currList : mekPilots) {currList.clear();}
        for (java.util.LinkedList<Pilot> currList : protoPilots) {currList.clear();}
        for (java.util.LinkedList<Pilot> currList : aeroPilots) {currList.clear();}
