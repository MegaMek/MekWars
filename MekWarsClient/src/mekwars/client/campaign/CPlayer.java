...
public class CPlayer extends Player {
    ...
    private java.util.Vector<mekwars.client.campaign.CUnit> Hangar;
    private java.util.Vector<mekwars.client.campaign.CArmy> Armies;
    private java.util.ArrayList<mekwars.client.campaign.CUnit> AutoArmy;

    private java.util.ArrayList<String> adminExcludes;
    private java.util.ArrayList<String> playerExcludes;
    ...
    private java.util.ArrayList<Integer> totalTechs = new java.util.ArrayList<Integer>(4);
    private java.util.ArrayList<Integer> availableTechs = new java.util.ArrayList<Integer>(4);
    ...
    public CPlayer(client.MWClient client) {
        mwclient = client;
        Name = "";
        Exp = 0;
        Money = 0;
        ...
        Rating = 0;
        House = "";
        Hangar = new java.util.Vector<mekwars.client.campaign.CUnit>(1, 1);
        Armies = new java.util.Vector<mekwars.client.campaign.CArmy>(1, 1);
        AutoArmy = new java.util.ArrayList<mekwars.client.campaign.CUnit>();
        personalPilotQueue = new CPersonalPilotQueues();
        adminExcludes = new java.util.ArrayList<String>();
        playerExcludes = new java.util.ArrayList<String>();
        myHouse = new House();
     ...
     */
    public void updateUnitData(java.util.StringTokenizer st) {
        try {
    ...
    public void updateUnitMachineGuns(java.util.StringTokenizer st) {
        try {
            CUnit currUnit = getUnit(TokenReader.readInt(st));
    ...
    public boolean removeArmy(int lanceID) {
        ...
        for (java.util.Iterator<mekwars.client.campaign.CArmy> i = Armies.iterator(); i.hasNext(); ) {
    ...
    public boolean removeUnit(int unitID) {
        ...
        for (java.util.Iterator<mekwars.client.campaign.CUnit> i = Hangar.iterator(); i.hasNext(); ) {
     ...
     */
    public java.util.Vector<mekwars.client.campaign.CArmy> getArmies() {
        return Armies;
    }
    ...
    public java.util.Vector<mekwars.client.campaign.CUnit> getHangar() {
        return Hangar;
    }
     ...
     */
    public void setAutoArmy(java.util.StringTokenizer st) {
     ...
     * Units are added to servers when a player joins a game, same as units from locked armies.
     */
    public void setAutoGunEmplacements(java.util.StringTokenizer st) {
    ...
    public void setMULCreatedArmy(java.util.StringTokenizer st) {
     ...
     */
    public java.util.ArrayList<mekwars.client.campaign.CUnit> getAutoArmy() {
        return AutoArmy;
    }
    ...
    public synchronized java.util.ArrayList<Unit> getLockedUnits() {

        java.util.ArrayList<Unit> result = new java.util.ArrayList<Unit>();
        for (CArmy currA : Armies) {
            if (currA.isLocked()) {
    ...
    public void addArmyUnit(String data) {
        java.util.StringTokenizer ST = new java.util.StringTokenizer(data, DELIMITER);
    ...
    public void setAdminExcludes(String buffer, String token) {
        adminExcludes.clear();
        java.util.StringTokenizer ST = new java.util.StringTokenizer(buffer, token);
        while (ST.hasMoreElements()) {
    ...
    public void sortHangar() {
        ...
        if ((tertiarySort != primarySort) &&
            ...
            java.util.Arrays.sort(unitsArray, new CUnitComparator(tertiarySort));
        }

        // run the second sort
        if ((primarySort != secondarySort) && (secondarySort != CUnitComparator.HQSORT_NONE)) {
            java.util.Arrays.sort(unitsArray, new CUnitComparator(secondarySort));
        }

        // now the primary sort
        if (primarySort != CUnitComparator.HQSORT_NONE) {
            java.util.Arrays.sort(unitsArray, new CUnitComparator(primarySort));
        }

        // overwrite the hangar with a new arraylist constructed from the
        // unitsArray.
        java.util.Vector<mekwars.client.campaign.CUnit> Hangar2 = new java.util.Vector<mekwars.client.campaign.CUnit>(1,
              1);
    ...
    public void sortArmies() {
        ...
        if ((tertiarySort != primarySort) &&
            ...
            java.util.Arrays.sort(armiesArray, new CArmyComparator(tertiarySort));
        }

        // run the second sort
        if ((primarySort != secondarySort) && (secondarySort != CArmyComparator.ARMYSORT_NONE)) {
            java.util.Arrays.sort(armiesArray, new CArmyComparator(secondarySort));
        }

        // now the primary sort
        if (primarySort != CArmyComparator.ARMYSORT_NONE) {
            java.util.Arrays.sort(armiesArray, new CArmyComparator(primarySort));
        }

        // overwrite the hangar with a new arraylist constructed from the
        // unitsArray.
        java.util.Vector<mekwars.client.campaign.CArmy> Army2 = new java.util.Vector<mekwars.client.campaign.CArmy>(1,
              1);
    ...
    public void applyUnitRepairs(java.util.StringTokenizer data) {
    ...
    public java.util.ArrayList<Integer> getTotalTechs() {
        return totalTechs;
    }
    ...
    public java.util.ArrayList<Integer> getAvailableTechs() {
    ...
    public void setMines(java.util.StringTokenizer st) {
    ...
    public void parseHangarPenaltyString(String readString) {
        java.util.StringTokenizer st = new java.util.StringTokenizer(readString, "*");
