...
public class CCampaign {
    ...
    CPlayer Player;
    java.util.TreeMap<Integer, mekwars.client.campaign.CBMUnit> BlackMarket = new java.util.TreeMap<Integer, mekwars.client.campaign.CBMUnit>();
    java.util.TreeMap<String, BMEquipment> BlackMarketParts = new java.util.TreeMap<String, BMEquipment>();
    java.util.TreeMap<String, ComponentToCritsConverter> ComponentConverter = new java.util.TreeMap<String, ComponentToCritsConverter>();

    public CCampaign(client.MWClient client) {
        mwclient = client;
        Player = new CPlayer(mwclient);
        java.io.File f = new java.io.File(client.MWClient.CAMPAIGN_PATH);
    ...
    public boolean decodeCommand(String command) {
        ...
        if (element.equals("CC")) // Campaign Command
        {
            ...
            if (commandid.equals("AT")) {//incoming attack
                ...
                mwclient.addToChat("<font color=\"red\"><b>Your forces are under attack!</b></font>",
            ...
            if (commandid.equals("NT")) {//next tick
                ...
                if (decrement) {
                    ...
                    mwclient.refreshGUI(client.MWClient.REFRESH_BMPANEL);
                }
            }
            return (true);
        }
    ...
    public java.util.TreeMap<Integer, mekwars.client.campaign.CBMUnit> getBlackMarket() {return BlackMarket;}

    public java.util.TreeMap<String, BMEquipment> getBlackMarketParts() {return BlackMarketParts;}

    public java.util.TreeMap<String, ComponentToCritsConverter> getComponentConverter() {return ComponentConverter;}
