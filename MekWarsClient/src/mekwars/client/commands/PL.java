...
public class PL extends Command {
    ...
    public void execute(String input) {
        ...
        if (cmd.equals("RA")) {
            ...
            client.updatePartsBlackMarket(TokenReader.readString(st),
        ...
        client.refreshGUI(MWClient.REFRESH_HQ PANEL);
        client.refreshGUI(MWClient.REFRESH_PLAYER PANEL);
        client.refreshGUI(MWClient.REFRESH_BM PANEL);
    }
}
