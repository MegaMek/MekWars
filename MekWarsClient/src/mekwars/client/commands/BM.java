...
public class BM extends Command {
    ...
    public void execute(String input) {
        ...
        client.refreshGUI(MWClient.REFRESH_HQ_PANEL);
        client.refreshGUI(MWClient.REFRESH_PLAYER_PANEL);
        client.refreshGUI(MWClient.REFRESH_BM_PANEL);
