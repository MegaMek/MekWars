    ...
    public class BuildTableCommand extends Command {
         ...
         *
         */
        public BuildTableCommand(MWClient client) {
            super(client);
        }
        ...
        public void execute(String input) {
            ...
            if (cmd.equalsIgnoreCase("LS")) {
                ...
                if (viewer) {
                    client.sendChat(MWClient.CAMPAIGN_PREFIX + "AdminRequestBuildTable view");
                }
            ...
            if (cmd.equalsIgnoreCase("PLS")) {
                ...
                if (viewer) {
                    client.sendChat(MWClient.CAMPAIGN_PREFIX + "RequestBuildTable view");
                }
