...
public class LPU extends Command {
     ...
     * @param client
     */
    public LPU(client.MWClient mwclient) {
        super(mwclient);
    }
    ...
    public void execute(String input) {
        ...
        javax.swing.JComboBox combo = new javax.swing.JComboBox(list.toArray());
        combo.setEditable(false);
        javax.swing.JOptionPane jop = new javax.swing.JOptionPane(combo, javax.swing.JOptionPane.QUESTION_MESSAGE,
              javax.swing.JOptionPane.OK_CANCEL_OPTION);

        javax.swing.JDialog dlg = jop.createDialog(mwclient.getMainFrame(), "Select a unit.");
        combo.grabFocus();
        ...
        if (value == javax.swing.JOptionPane.CANCEL_OPTION) {return;}
        ...
        } else {mwclient.sendChat(client.MWClient.CAMPAIGN_PREFIX + "c " + commandName + "#" + username + unit);}
    }
}
