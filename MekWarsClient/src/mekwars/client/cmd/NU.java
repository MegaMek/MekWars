...
public class NU extends Command {
     ...
     * @param client
     */
    public NU(client.MWClient mwclient) {
        super(mwclient);
    }
    ...
    public void execute(String input) {
        ...
        client.CUser newUser = new client.CUser(st.nextToken());

        //Check the Users and remove the User
        client.CUser user = mwclient.getUser(newUser.getName());
        ...
        if (newUser.isInvis() &&
                  newUser.getUserlevel() > mwclient.getUser(mwclient.getPlayer().getName()).getUserlevel()) {
