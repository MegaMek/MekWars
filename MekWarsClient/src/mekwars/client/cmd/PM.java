...
public class PM extends Command {
     ...
     */
    public PM(client.MWClient mwclient) {
        super(mwclient);
    ...
    public void execute(String input) {
        ...
        if (st.hasMoreElements()) {
            ...
            if (!mwclient.isIgnored(name, client.MWClient.IGNORE_PRIVATE) && st.hasMoreElements()) {
                ...
                client.CUser sender = mwclient.getUser(name);
                ...
                //add timestamp
                if (mwclient.getConfig().isParam("TIMESTAMP")) {message = mwclient.getShortTime() + message;}
