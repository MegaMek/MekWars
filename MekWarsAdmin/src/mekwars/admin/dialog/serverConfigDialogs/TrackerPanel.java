 ...
 * @author Spork
 *       <p>
 *       A JPanel where we configure everything having to do with the tracker.  Currently only recreating the old
 *       tracker information.  Next step is to add HPGNet capabilities
 *
 */
