...
public class PilotSkillsCardPanel extends JPanel {
    ...
    public PilotSkillsCardPanel(MWClient mwclient) {
        ...
        admin.dialog.serverConfigDialogs.PilotSkillsModPanel psModPanel = new admin.dialog.serverConfigDialogs.PilotSkillsModPanel(
              mwclient);
        ...
        baseTextField = new admin.dialog.serverConfigDialogs.PilotSkillTextField(50, new Dimension(50, 20));
