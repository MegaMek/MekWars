...
public class PayoutModPanel extends JPanel {
    ...
    public PayoutModPanel() {
        ...
        upperPanel.setPreferredSize(new Dimension(Math.max(upperPanel.getPreferredSize().width,
              fluPanel.getPreferredSize().width), upperPanel.getPreferredSize().height));

        // Exp Mod panel
        JPanel expModPanel = new JPanel();
        expModPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createRaisedBevelBorder(),
              "Experience Mod"));
