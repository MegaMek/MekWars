    ...
    private void init() {
        ...
        for (int unitType = Unit.MEK; unitType <= Unit.INFANTRY; unitType++) {
            for (int unitWeight = Unit.LIGHT; unitWeight <= Unit.ASSAULT; unitWeight++) {
                ...
                baseTextField.setToolTipText(Unit.getWeightClassDesc(unitWeight) +
        ...
        commandersPanel.setPreferredSize(new Dimension(unitUsePanel.getPreferredSize().width,
              commandersPanel.getPreferredSize().height));
        miscCheckBoxPanel.setPreferredSize(new Dimension(unitUsePanel.getPreferredSize().width,
              miscCheckBoxPanel.getPreferredSize().height));
        weightPanel.setPreferredSize(new Dimension(unitUsePanel.getPreferredSize().width,
              weightPanel.getPreferredSize().height));
        typesPanel.setPreferredSize(new Dimension(unitUsePanel.getPreferredSize().width,
              typesPanel.getPreferredSize().height));
        miscPanel.setPreferredSize(new Dimension(unitUsePanel.getPreferredSize().width,
        ...
        costsButton.addActionListener(e -> cl.first(bottomPanel));
