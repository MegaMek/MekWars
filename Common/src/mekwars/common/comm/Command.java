...
public abstract class Command extends Thread implements ClientCommand, common.comm.ServerCommand {
	...
	public static class Table extends Hashtable<String, common.comm.ICommand> {
		/**
         *
         */
        private static final long serialVersionUID = -4187092531938444178L;

        public void put(common.comm.ICommand c) {
