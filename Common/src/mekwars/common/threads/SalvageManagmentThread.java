...
public class SalvageManagmentThread extends Thread {
    ...
    public SalvageManagmentThread(Long repairTime, IClient client) {
        ...
        for (int x = 0; x <= UnitUtils.TECH_PILOT; x++) {
            java.util.concurrent.ConcurrentLinkedQueue<String> tempVector = new java.util.concurrent.ConcurrentLinkedQueue<>();
                    ...
                    synchronized (unit) {
                        ...
                        if (!armor) {
                            ...
                            if (slot == UnitUtils.LOC_FRONT_ARMOR) {
                                ...
                                if (location >= UnitUtils.LOC_CENTER_TORSO) {tempLocation -= 7;}
                                ...
                                if (location >= UnitUtils.LOC_CENTER_TORSO) {location -= 7;}
