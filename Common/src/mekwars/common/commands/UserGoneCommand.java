...
public class UserGoneCommand extends Command {
     ...
     * @param client
     */
    public UserGoneCommand(IClient mwclient) {
        super(mwclient);
    }
    ...
    public void execute(String input) {
        ...
        //UserGoneCommand = User Gone (UserGoneCommand|<MMClientInfo.toString>|[Gone]) Gone is used when the client didn't just change his name
        ...
        if ((mmci.isInvis() && mmci.getUserlevel() > client.getUserLevel())
