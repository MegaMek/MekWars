 ...
 * <p>
 * HOWTO ADD A NEW COMMAND ----------------------- - Subclass Command. Put your class in package dedicatedhost.cmd -
 * Name your class like the command in the chat input (e.g. "HS" for faction status) - Provide an constructor with one
 * MMClient argument. - implement execute to do the things you want to be done. - Remember that your command get only
 * constructed once and execute will be called on the same object over and over again...
 * <p>
