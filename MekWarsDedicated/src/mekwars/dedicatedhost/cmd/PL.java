...
public class PL extends Command {
    ...
    public void execute(String input) {
        ...
        {mwclient.getConnector().closeConnection();} else if (cmd.equals("RSOD"))//Retrieve Short Op Data
        {mwclient.retrieveOpData("short", st.nextToken());} else if (cmd.equals("UCP"))//Update/Set a clients param
        {mwclient.updateParam(st);} else if (cmd.equals("RMF")) {
