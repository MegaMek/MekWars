 ...
 * @author jtighe
 *       <p>
 *       This class loads the default server config options as well as saves the server configs back to the serverconfig
 *       file
 */
...
public class DefaultServerOptions {
    ...
    protected void createDefaults() {
        ...
        defaults.setProperty("OnlyUseOriginalFactoriesForAutoprod",
        ...
        defaults.setProperty("MaxAllowedPilotsInQueueToBuyFromHouse",
              "2"); // if the player has more then 2 pilots in their queue of size and wieght they
        // cannot buy from the faction.
        defaults.setProperty("BasePilotSurvival",
              "20"); // if the player has more then 2 pilots in their queue of a size and wieght they cannot buy from the
        // faction.
        defaults.setProperty("TrappedInMechSurvivalMod",
              "-20"); // If the pilot was still in his mek when it died this mod is applied to the surival rate.
        defaults.setProperty("DownPilotsMustRollForSurvival",
              "false"); // engined and cored meks whoes pilots are alive may have to check for survival
        defaults.setProperty("ChanceToConvertCapturedPilots",
        ...
        defaults.setProperty("MeleeSpecialistUseSpeedFactor",
    ...
    public java.util.Properties getServerDefaults() {
        return defaults;
    }
}
