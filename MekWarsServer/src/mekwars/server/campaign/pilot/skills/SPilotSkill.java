 ...
 * SLevelPilotSkill if you want a skill with different Levels.
 * <p>
 * Also note, that the skill should not hold any internal state depending on any parameter passed to any function to it,
 * since the instance created only once and then shared among all pilots.
 *
...
public abstract class SPilotSkill extends PilotSkill {
     ...
     * <p>
     * Do not touch the skill list of a pilot here, but change the other stats. The skill will be automatically add to
     * the pilot's list.
     */
    ...
    /**
     * Override this, if you want a special handling of how the skill is added to the pilot's skill list. As example it
     * could remove other skills on its list (look at SLevelPilotSkill), or auto-add another skill (you have to call
     * modifyPilot for that auto-added by yourself!).
     */
    ...
    /**
     * This is called by the pilot's level-up to determinate whether the class can be used for this pilot. getChance
     * should return 0 if this skill cannot be used (as example because the pilot has already that skill).
     */
