...
public class Vote {
     ...
     *       <p>
     *       Take two votes and see if they have the same elements: Caster, Recipient and Type.
     */
    public boolean isEqualTo(mekwars.server.campaign.votes.Vote v, boolean typeCounts) {
