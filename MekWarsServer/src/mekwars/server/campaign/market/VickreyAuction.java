...
public final class VickreyAuction implements IAuction {
    ...
    public MarketBid getWinner(MarketListing listing, boolean hiddenBM) {
        ...
        if (i.hasNext()) {
            ...
            IBuyer potentialWinner = CampaignMain.campaignMain.getPlayer(nextBid.getBidderName());
            if (potentialWinner == null) {
                potentialWinner = CampaignMain.campaignMain.getHouseFromPartialString(nextBid.getBidderName(),
                      null);
            }
