...
public final class MarketListing {
    ...
    private java.util.TreeMap<String, mekwars.server.campaign.market.MarketBid> bidsReceived;
    ...
    public MarketListing(String sellname, server.campaign.SUnit unit, int minbid, int duration) {
        ...
        bidsReceived = new java.util.TreeMap<String, mekwars.server.campaign.market.MarketBid>();
     ...
     */
    public java.util.TreeMap<String, mekwars.server.campaign.market.MarketBid> getAllBids() {
        return bidsReceived;
    }
