...
public class NewOperationManager extends AbstractOperationManager implements I_OperationManager {
    ...
    private server.campaign.operations.OperationManager tempOpManager = new server.campaign.operations.OperationManager();
    ...
    /**
     * Method to get a long ID.  In order to stop the issue we're seeing where scrap is being sent to the wrong players,
     * I am not reusing IDs
     *
    ...
    @Override
    public String validateShortDefense(
          server.campaign.SPlayer dp, server.campaign.SArmy da, Operation o, server.campaign.SPlanet target) {
        // TODO Auto-generated method stub
