...
public class LongValidator {
    ...
    /**
     * Method which checks a players army vs. an operation type to see if the army can be used to attack/defend.
     * <p>
     * Returns a vector of failure codes.
     */
    public java.util.ArrayList<Integer> validateLongOp(
          server.campaign.SPlayer p, server.campaign.SHouse ah, server.campaign.SPlanet pl, Operation o) {
         ...
         */
        java.util.ArrayList<Integer> failList = new java.util.ArrayList<Integer>();
    ...
    public String failuresToString(java.util.ArrayList<Integer> failList) {
        ...
        if (failList.size() == 1) {return s += " because " + this.decodeFailure((Integer) failList.get(0)) + ".";}
    ...
    /**
     * Method (private) which converts a given failure code into a string. Helper for this.failuresToString
     */
