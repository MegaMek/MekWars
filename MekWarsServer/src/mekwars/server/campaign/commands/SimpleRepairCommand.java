...
public class SimpleRepairCommand implements Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        java.util.Vector<Integer> techs = new java.util.Vector<Integer>(7, 1);
        java.util.Vector<Integer> rolls = new java.util.Vector<Integer>(7, 1);
