...
public class SetUnitAmmoByCritCommand implements Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        // for ammo
        double ammoCharge = server.campaign.CampaignMain.cm.getAmmoCost(currAmmo.getInternalName());
        ...
        if ((ammoCharge > 0) || usingCrits) {
            ...
            if (usingCrits) {
                ...
                if (newAmmoAmount == 0) {
                    String result = "AM:After unloading " +
                                          currAmmo.getDesc() +
                                          "(" +
            ...
            if (!strConfirm.equals("CONFIRM")) {
                String result = "AM:Quartermaster command will charge you " +
                                      ...
                                      refillShots +
                                      ").";
                result += "AM:<br><a href=\"MEKWARS/c setunitammobyCrit#" +
                                unitid +
                                "#" +
                                weaponLocation +
                                "#" +
    ...
    private int getWeaponRefillShots(server.campaign.SUnit unit, Mounted weapon) {
        ...
        Entity tempEnt = server.campaign.SUnit.loadMech(unit.getUnitFilename());
