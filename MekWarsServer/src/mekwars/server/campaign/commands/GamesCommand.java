...
public class GamesCommand implements Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        for (server.campaign.operations.ShortOperation currO : server.campaign.CampaignMain.cm.getOpsManager()
            ...
            if (currO.getStatus() == server.campaign.operations.ShortOperation.STATUS_FINISHED) {
            ...
            //add waiting, running and reporting games to runningGames
                ...
                String currInfo = "";
                if (currO.hasPlayerFrom(p.getMyHouse())) {currInfo += "<br>" + currO.getInfo(true, false);} else {
        ...
        //list finished games
        if (timeSort.size() == 0) {finishedGames += "<br>- None";} else {
            for (server.campaign.operations.ShortOperation currO : timeSort.values()) {
