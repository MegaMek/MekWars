...
public class PlayerUnlockArmyCommand implements Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.campaignMain.toUser("AM:Improper format. Try: /c playerunlockarmy#ID", Username, true);
            return;
        }
        ...
        CampaignMain.campaignMain.toUser("AM:Army " + army.getID() + " unlocked.", Username, true);
    }
