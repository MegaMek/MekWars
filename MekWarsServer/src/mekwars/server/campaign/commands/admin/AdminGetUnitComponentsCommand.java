 ...
 * @author Jason Tighe
 */
public class AdminGetUnitComponentsCommand implements server.campaign.commands.Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        try {
            ...
            if (option.equalsIgnoreCase("DisplayParts")) {
                ...
                int unitID = Integer.parseInt(command.nextToken());
                server.campaign.SUnit m = target.getUnit(unitID);
                java.util.Hashtable<String, Integer> components = new java.util.Hashtable<String, Integer>();
