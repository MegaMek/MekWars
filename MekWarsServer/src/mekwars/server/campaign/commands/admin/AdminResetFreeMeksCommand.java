...
public class AdminResetFreeMeksCommand implements server.campaign.commands.Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.campaignMain.toUser("Improper command. Try: /c resetfreemeks#name", Username, true);
            return;
        }
        ...
        CampaignMain.campaignMain.toUser("You reset " + p.getName() + "'s free mek limit.", Username, true);
        CampaignMain.campaignMain.toUser(Username + " reset your free mek limit.", p.getName(), true);
