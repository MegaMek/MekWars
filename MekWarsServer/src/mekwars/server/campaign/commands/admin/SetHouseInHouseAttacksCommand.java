...
public class SetHouseInHouseAttacksCommand implements server.campaign.commands.Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        try {
            ...
            CampaignMain.campaignMain.toUser("Improper command. Try: /c sethouseinHouseAttacks#Faction#true/false",
                  Username,
                  true);
            return;
        }
        ...
        h.updated();
        CampaignMain.campaignMain.toUser("You set " + h.getName() + "'s infaction attack status to " + conquer,
              Username,
              true);
