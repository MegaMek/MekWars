        ...
        switch (rewardSelection) {
            case 0:  //buying techs.
                ...
                if (CampaignMain.campaignMain.isUsingAdvanceRepair()) {
                    int techCost = MathUtility.parseInt(house.getConfig(String.format("RewardPointsFor%s", UnitUtils.techDescription(
                          rewardPoints))), 0);
            ...
            case 2: //buying units
                ...
                if (faction != null && !player.getHouseFightingFor().equals(faction)) {
                    ...
                    if (nonHouseUnitMod < 0) {
                        nonHouseUnitMod = MathUtility.parseDouble(house.getConfig("RewardPointNonHouseMultiplier"),
                              0.0);
                    }
                ...
                try {
                    //Let's get us a pilot and a unit
            ...
            case 3://repairs
                rewardPoints = MathUtility.parseInt(house.getConfig("RewardPointsForRepair"), -1);
                ...
                CampaignMain.campaignMain.toUser(String.format("AM:Unit #%s %s is now fully repaired.", unitID, unit.getModelName()),
                      Username,
                      true);
                CampaignMain.campaignMain.toUser(String.format("PL|UU|%s|%s", unit.getId(), unit.toString(true)),
                      Username,
                      false);
                player.addReward(-rewardPoints);
            ...
            case 4: //buying CBills
                ...
                if (!(MathUtility.parseBoolean(house.getConfig("AllowCBillsForRewards"), false))) {
                ...
                int amountOfCBillsBought = MathUtility.parseInt(house.getConfig("CBillsForARewardPoint"), 0);
                ...
                CampaignMain.campaignMain.toUser(String.format("AM:You've bought %s for %s %s.", CampaignMain.campaignMain.moneyOrFluMessage(
                            true,
                            false,
                            amountOfCBillsBought), rewardPoints, CampaignMain.campaignMain.getConfig("RPLongName")),
                      Username,
                      true);
