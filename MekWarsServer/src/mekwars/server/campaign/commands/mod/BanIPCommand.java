    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        try {
            ...
            if (ip.equals(java.net.InetAddress.getLocalHost())) {
                CampaignMain.campaignMain.toUser("AM:You may not ban the localhost.", Username);
                return;
            }
            ...
            CampaignMain.campaignMain.toUser("AM:Incorrect Syntax: Syntax is as follows<br>/c banip ip#time" +
        ...
        if (ip != null) {CampaignMain.campaignMain.getServer().getBanIps().put(ip, until);}

        CampaignMain.campaignMain.getServer().bansUpdate();
        //MWLogger.modLog(Username + " banned " + toKill + " " +timeName+".");
        CampaignMain.campaignMain.getServer().sendChat(Username + " banned " + toKill + " " + timeName + ".");
    }
