 ...
 */
public class ViewPlayerPersonalPilotQueueCommand implements server.campaign.commands.Command {
    ...
    public void process(java.util.StringTokenizer command, String Username) {
        ...
        for (int weightClass = Unit.LIGHT; weightClass <= Unit.ASSAULT; weightClass++) {
            ...
            java.util.LinkedList<Pilot> currList = p.getPersonalPilotQueue().getPilotQueue(Unit.MEK, weightClass);
            if (currList.size() != 0) {
        ...
        for (int weightClass = Unit.LIGHT; weightClass <= Unit.ASSAULT; weightClass++) {
            ...
            java.util.LinkedList<Pilot> currList = p.getPersonalPilotQueue().getPilotQueue(Unit.PROTOMEK, weightClass);
            if (currList.size() != 0) {
        ...
        for (int weightClass = Unit.LIGHT; weightClass <= Unit.ASSAULT; weightClass++) {
            ...
            java.util.LinkedList<Pilot> currList = p.getPersonalPilotQueue().getPilotQueue(Unit.AERO, weightClass);
            if (currList.size() != 0) {
