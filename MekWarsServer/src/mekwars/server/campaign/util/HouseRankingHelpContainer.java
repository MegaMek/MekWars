...
public class HouseRankingHelpContainer implements Comparable<Object> {
    server.campaign.SHouse faction;
    int amount;

    public HouseRankingHelpContainer(server.campaign.SHouse h) {
        this.faction = h;
        amount = 0;
    }
    ...
    public int compareTo(Object o) {
        mekwars.server.campaign.util.HouseRankingHelpContainer h = (mekwars.server.campaign.util.HouseRankingHelpContainer) o;
    ...
    public server.campaign.SHouse getHouse() {
        return faction;
    }

    public void setHouse(server.campaign.SHouse h) {
        this.faction = h;
    }
