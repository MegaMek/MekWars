...
public class XMLFactionDataParser implements XMLResponder {
    ...
    java.util.Vector<server.campaign.SHouse> Factions = new java.util.Vector<server.campaign.SHouse>(1, 1);
    ...
    public java.util.Vector<server.campaign.SHouse> getFactions() {
        return Factions;
    }
    ...
    public void recordElementEnd(String name) throws ParseException {
        if (name.equalsIgnoreCase("FACTION")) {
            ...
            idcounter++;
            if (this.isMercenary) {
                h = new server.campaign.mercenaries.MercHouse(idcounter,
                      Name,
                      Color,
                      BaseGunner,
                      BasePilot,
                ...
                h = new server.campaign.NewbieHouse(idcounter, Name, Color, BaseGunner, BasePilot, Abbreviation);
            } else {h = new server.campaign.SHouse(idcounter, Name, Color, BaseGunner, BasePilot, Abbreviation);}
    ...
    public void recordCharData(String charData) {
        ...
        if (lastElement.equalsIgnoreCase("NAME")) {Name = charData;} else if (lastElement.equalsIgnoreCase("MONEY")) {
            Money = Integer.parseInt(charData);
        } else if (lastElement.equalsIgnoreCase("COLOR")) {Color = charData;} else if (lastElement.equalsIgnoreCase(
              "ABBREVIATION")) {
            Abbreviation = charData;
        } else if (lastElement.equalsIgnoreCase("LOGO")) {Logo = charData;} else if (lastElement.equalsIgnoreCase(
              "BASEGUNNER")) {
        ...
        } else if (lastElement.equalsIgnoreCase("ISNEWBIE")) {isNewbie = Boolean.parseBoolean(charData);}
    }
    ...
    public java.io.InputStream getDocumentStream() throws ParseException {
        try {return new java.io.FileInputStream(Filename);} catch (java.io.FileNotFoundException e) {
    ...
    public java.io.InputStream resolveExternalEntity(String name, String pubID, String sysID) throws ParseException {
        if (sysID != null) {
            ...
            try {return new java.io.FileInputStream(f);} catch (java.io.FileNotFoundException e) {
