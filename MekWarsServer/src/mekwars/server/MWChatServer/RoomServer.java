...
public class RoomServer implements ICommands {
    ...
    protected java.util.ArrayList<MWChatClient> _users;
    protected java.util.HashMap<String, MWChatClient> _ops;
...
/*        String msg = _server.getWelcomeMsg(client, _roomName);
     ...
     * @param isSignoff true if the client is signing off; false if the client is leaving only this room.
     *
