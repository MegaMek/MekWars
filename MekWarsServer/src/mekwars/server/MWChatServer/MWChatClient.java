...
public class MWChatClient implements IConnectionListener, ICommands {
     ...
     * <p>
     * The proper way to kill a connection is with MWChatServer.SignOff(). Only the MWChatServer should call this.
     */
    public void die() {
    ...
    /**
     * Create an ackkill message and send it to the client. This confirms that this MWChatClient made a kill.
     *
