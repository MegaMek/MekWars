...
/**
 * A wrapper around the com.lyrisoft.util.i18n.Translator object that provides static methods that can be called from
 * anywhere, and an init() method that should be called once, early on.
 */
