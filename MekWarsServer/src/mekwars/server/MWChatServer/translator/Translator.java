...
/**
 * This class "translates" things by using a specially formatted varibles that can be substituted.  A properties file,
 * which is really just key/value pairs, might look something like this:
 *
 * <pre>
 ...
 * <p>
 * The "translation" part is actually a manual step, in that somebody has to actually create a translated version of the
 * properties file(s).
 */
