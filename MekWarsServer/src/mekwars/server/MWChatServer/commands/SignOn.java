...
public class SignOn extends CommandBase implements ICommands {
    ...
    public boolean process(server.MWChatServer.MWChatClient client, String[] args) {
        ...
        if (client.getUserId() != null) {
            client.generalError(server.MWChatServer.Translator.getMessage("already_on"));
            return false;
        }
        ...
        try {
            ...
            server.MWServ server = ((server.ServerWrapper) client.getServer()).getMWServ();
            ...
            if (username.startsWith("Nobody")) {
                ...
                CampaignMain.cm.toUser("SSC|UseAdvanceRepair|" +
