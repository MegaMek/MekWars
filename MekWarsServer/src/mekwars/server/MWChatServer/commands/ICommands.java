...
/**
 * This class describes the protocol between the server and the client. Contained in here are a whole bunch of constants
 * that represent commands going over the wire.  A command consists of string arguments separated by DELIMITER.  The
 * recipient of a command determines what the command is by looking at the first argument.  The first argument will be a
 * string from this class (at least for the core set of commands).
 * <p>
...
public interface ICommands {
     ...
     * <p>
     * args: none<br> acknowledgement: none
     */
     ...
     * Sign on to server.<p>
     * <p>
     * args: username, (password)<br> acknowledgement: SIGNON_ACK
     *
     * @see #SIGNON_ACK
     */
     ...
     * <p>
     * args: none<br> acknowledgement: the server will hang up
     */
     ...
     * <p>
     * args: userId<br> acknowledgement: plain text
     */
     ...
     * Version<p>
     * <p>
     * Tell the server about what version of the client this is. This can be a freeform string.  The first
     * space-delmited token should be the protocol version implemented: 1.0 = basic; 1.1 = basic + deflate. The default
     * implementation sends "NFC Classic. Java version <vendor> - <version> on <os>".
     * <p>
     * It is suggested that writers of new clients send this command once, after authentication takes place.<p>
     * <p>
     * args: the version string<br> acknowledgement: none
     */
     ...
     * <p>
     * args: room, userid, (message)<br> acknowledgement: a confirmation message
     */
     ...
     * <p>
     * args: room, userid<br> acknowledgement: a confirmation message
     *
     */
     ...
     * List ignored users
     * <p>
     * args: none acknowledgement: list of users
     */
     ...
     * <p>
     * args: user, message body acknowledgement: MAIL_ACK
     */
     ...
     * <p>
     * args: userid of user to ignore, (message)<br> acknowledgement: a general message
     */
     ...
     * <p>
     * args: userid of user to remember, (message)<br> acknowledgement: a general message
     */
     ...
     * args: room, message<br> acknowledgement: a SAY_TO_ROOM message from the server<p>
     *
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: recipient, message<br> acknowledgement: none<p>
     *
     * <i>When sent from the server...</i><br>
     * args: sender,  message
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: recipient, emote<br> acknowledgement: none<p>
     *
     * <i>When sent from the server...</i><br>
     * args: sender,  message
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: room<br> acknowledgement: JOIN_ROOM_ACK<p>
     *
     * <i>When sent from the server...</i><br>
     * Denotes that a new user just joined a room, and will only be sent to clients who are currently "in" that
     * room.<br> args: user, room
     *
     * @see #JOIN_ROOM_ACK
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: room<br> acknowledgement: PART_ROOM_ACK<p>
     *
     * <i>When sent from the server...</i><br>
     * Denotes that a user just left a room, and will only be sent to clients who are currently "in" that room.<br>
     * args: user, room
     *
     * @see #PART_ROOM_ACK
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: room<br> acknowledgement: GET_USERS_IN_ROOM<p>
     *
     * <i>When sent from the server...</i><br>
     * A response to a client request.<br> args: room, room, ........
     *
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: none<br> acknowledgement: GET_USERS_ON_SERVER<p>
     *
     * <i>When sent from the server...</i><br>
     * A response to a client request.<br> args: user, user, ........
     *
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: none<br> acknowledgement: GET_ROOMS<p>
     *
     * <i>When sent from the server...</i><br>
     * A response to a client request.<br> args: room, number of users, room, number of users, ........
     *
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * args: current time (milliseconds)<br> acknowledgement: PONG<p>
     *
     * <i>When sent from the server...</i><br>
     * Notify a user that he is being pinged<br> args: current time (milliseconds)<br> acknowledgement: PONG
     *
     * @see #PONG
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * Response to a ping<br> args: current time (milliseconds)<br> acknowledgement: none<p>
     *
     * <i>When sent from the server...</i><br>
     * The final reply to a PING<br> args: current time (milliseconds)<br> acknowledgement: none
     *
     * @see #PING
     */
     ...
     *
     * <i>When sent from the client...</i><br>
     * Request to kill somebody<br> args: user to kill<br> acknowledgment: ACK_KILL<p>
     *
     * <i>When sent from the server...</i><br>
     * Tells you that you have been killed.<br> args: the user who killed you, a message<p>
     */
     ...
     * <p>
     * args: the room<br> in response to: JOIN_ROOM
     *
     * @see #JOIN_ROOM
     */
     ...
     * <p>
     * args: the room<br> in response to: PART_ROOM
     *
     * @see #PART_ROOM
     */
     ...
     * <p>
     * args: none<br> in response to: SIGNON<br>
     *
     * @see #SIGNON
     */
    ...
    /**
     * Indicates that a message should be displayed on the client as coming from a particular room<p>
     * <p>
     * args: room, the message<br> in response to: EMOTE, any time the server feels like sending a message that
     * logically belongs in a room.
     *
     * @see #EMOTE_TO_ROOM
     */
