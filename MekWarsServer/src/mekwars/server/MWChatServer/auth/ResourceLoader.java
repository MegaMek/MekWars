...
/**
 * A class that loads resources from locations relative to the CLASSPATH, or relative to the ServletContext if one is
 * specified.
 * <p>
...
public class ResourceLoader {
    ...
    /**
     * Load a resource from the CLASSPATH.  relativePath should use forward-slashes and omit the first slash.
     * <p>
     * e.g., getResource("path/to/my/resource");
     *
     * @param relativePath
     */
    public static java.io.InputStream getResource(String relativePath) throws Exception {
        ...
        java.io.InputStream is = ClassLoader.getSystemResourceAsStream(relativePath);
        if (is == null) {
