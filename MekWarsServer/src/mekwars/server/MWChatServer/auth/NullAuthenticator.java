...
public class NullAuthenticator implements IAuthenticator {
    protected server.MWChatServer.MWChatServer _server;
    ...
    public NullAuthenticator(server.MWChatServer.MWChatServer server, boolean allowGuests, boolean storeGuests) {
        _server = server;
    ...
    public Auth authenticate(server.MWChatServer.MWChatClient client, String password) throws Exception {
    ...
    public String getUserId(String target) {
        server.MWChatServer.MWChatClient c = _server.getClient(target);
