...
public interface IRoomAuthenticator {
    ...
    // to be open to all.
    public boolean isCreateAllowed(server.MWChatServer.MWChatClient client, String room, String password);
    ...
    public int getAccessLevel(server.MWChatServer.MWChatClient client, server.MWChatServer.RoomServer room);
    ...
    public server.MWChatServer.MWChatClient getNextOp(server.MWChatServer.RoomServer room);
}
