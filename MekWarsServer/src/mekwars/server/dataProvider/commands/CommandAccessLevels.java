 ...
 */
public class CommandAccessLevels implements server.dataProvider.ServerCommand {
    ...
    public void execute(java.util.Date timestamp, BinWriter out, CampaignData data)
          throws Exception {
        java.util.Hashtable<String, Command> commandTable = CampaignMain.cm.getServerCommands();
