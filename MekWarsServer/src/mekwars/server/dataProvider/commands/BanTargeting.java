 ...
 */
public class BanTargeting implements server.dataProvider.ServerCommand {
    ...
    public void execute(java.util.Date timestamp, BinWriter out, CampaignData data) throws Exception {
        ...
        if (!new java.io.File("./campaign/bantargeting.dat").exists()) {
            return;
        }
        java.io.FileInputStream configFile = new java.io.FileInputStream("./campaign/bantargeting.dat");
