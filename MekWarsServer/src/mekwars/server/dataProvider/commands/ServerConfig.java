 ...
 */
public class ServerConfig implements server.dataProvider.ServerCommand {
    ...
    public void execute(java.util.Date timestamp, BinWriter out, CampaignData data)
          throws Exception {
        java.io.FileInputStream configFile = new java.io.FileInputStream(CampaignMain.cm.getServer()
